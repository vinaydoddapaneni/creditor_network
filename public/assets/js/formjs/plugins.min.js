! function(e, t) {
    ...
    var J, G, Q, K = function(e, t, n, r, i, o, a) {
            ...
            else if (void 0 !== r && (i = !0, E.isFunction(r) || (a = !0), l && (t = a ? (t.call(e, r), null) : (l = t, function(e, t, n) {
                    return l.call(E(e), n)
                })), t))
    ...
    function at(e, t, n) {
        ...
        if (h.msFullscreenElement && C.top !== C && e.getClientRects().length && (i = Math.round(100 * e.getBoundingClientRect()[t])), i <= 0 || null == i) {
...
! function(e, t) {
    ...
    function h(e) {
        ...
        var t = y(e),
            ...
            o = t.overflowX,
            r = t.overflowY;
        return /(auto|scroll|overlay)/.test(n + r + o) ? e : h(d(e))
    }

    function b(e) {
        if (!e) return document.documentElement;
        for (var t = Y(10) ? document.body : null, n = e.offsetParent; n === t && e.nextElementSibling;) n = (e = e.nextElementSibling).offsetParent;
        var o = n && n.nodeName;
        return o && "BODY" !== o && "HTML" !== o ? -1 !== ["TD", "TABLE"].indexOf(n.nodeName) && "static" === y(n, "position") ? b(n) : n : e ? e.ownerDocument.documentElement : document.documentElement
    }
    ...
    function c(e, t) {
        ...
        if (e !== f && t !== f || o.contains(r)) return "BODY" === (a = (s = f).nodeName) || "HTML" !== a && b(s.firstElementChild) !== s ? b(f) : f;
        var p = l(e);
        return p.host ? c(p.host, t) : c(e, l(t).host)
    }
    ...
    function o(e, t, n, o) {
        return C(t["offset" + e], t["scroll" + e], n["client" + e], n["offset" + e], n["scroll" + e], Y(10) ? n["offset" + e] + o["margin" + ("Height" === e ? "Top" : "Left")] + o["margin" + ("Height" === e ? "Bottom" : "Right")] : 0)
    }

    function g() {
        var e = document.body,
            t = document.documentElement,
            n = Y(10) && getComputedStyle(t);
        return {
            height: o("Height", e, t, n),
            width: o("Width", e, t, n)
        }
    }
    ...
    function w(e) {
        ...
        if (f || p) {
            var l = y(e);
            f -= u(l, "x"), p -= u(l, "y"), r.width -= f, r.height -= p
        }
        return E(r)
    }
    ...
    function v(e, t) {
        ...
        n && "HTML" === t.nodeName && (s.top = C(s.top, 0), s.left = C(s.left, 0));
        var u = E({
            top: i.top - s.top - p,
    ...
    function O(e, t, n, o) {
        ...
        if ("viewport" === o) i = function(e) {
            var t = 1 < arguments.length && void 0 !== arguments[1] && arguments[1],
                ...
                o = v(e, n),
                r = C(n.clientWidth, window.innerWidth || 0),
                i = C(n.clientHeight, window.innerHeight || 0),
                s = t ? 0 : m(n),
                a = t ? 0 : m(n, "left");
            return E({
            ...
            var a;
            "scrollParent" === o ? "BODY" === (a = h(d(t))).nodeName && (a = e.ownerDocument.documentElement) : a = "window" === o ? e.ownerDocument.documentElement : o;
            var f = v(a, s, r);
            if ("HTML" !== a.nodeName || function e(t) {
                    var n = t.nodeName;
                    return "BODY" !== n && "HTML" !== n && ("fixed" === y(t, "position") || e(d(t)))
                }(s)) i = f;
            else {
                var p = g(),
                    l = p.height,
                    u = p.width;
                i.top += f.top - f.marginTop, i.bottom = l + f.top, i.left += f.left - f.marginLeft, i.right = u + f.left
            }
        }
    ...
    function a(e, t, o, n, r) {
        ...
        var s = O(o, n, i, r),
            ...
            f = Object.keys(a).map(function(e) {
                return z({
                    key: e
                }, a[e], {
    ...
    function D(e, t, n) {
        ...
        var o = L(e),
            ...
            f = i ? "height" : "width",
            p = i ? "width" : "height";
        return r[s] = t[s] + t[f] / 2 - o[f] / 2, r[a] = n === a ? t[a] - o[p] : t[T(a)], r
    }
    ...
    function t(e, t, n, o) {
        ...
        return function e(t, n, o, r) {
            ...
            s.addEventListener(n, o, {
                passive: !0
            }), i || e(h(s.parentNode), n, o, r), r.push(s)
    ...
    function p(n, o) {
        Object.keys(o).forEach(function(e) {
            var t = ""; - 1 !== ["width", "height", "top", "right", "bottom", "left"].indexOf(e) && A(o[e]) && (t = "px"), n.style[e] = o[e] + t
        })
    }
    ...
    function r(e) {
        var t = 1 < arguments.length && void 0 !== arguments[1] && arguments[1],
            n = _.indexOf(e),
            o = _.slice(n + 1).concat(_.slice(0, n));
            ...
            return e.reduce(function(e, t) {
                ...
                return function(e, t, n, o) {
                    var r, i = e.match(/((?:\-|\+)?\d*\.?\d*)(.*)/),
                        ...
                        a = i[2];
                    if (!s) return e;
                    if (0 !== a.indexOf("%")) return "vh" !== a && "vw" !== a ? s : ("vh" === a ? C(document.documentElement.clientHeight, window.innerHeight || 0) : C(document.documentElement.clientWidth, window.innerWidth || 0)) / 100 * s;
                    switch (a) {
                        case "%p":
                            r = n;
                            break;
    ...
    for (var P = Math.min, B = Math.floor, C = Math.max, W = "undefined" != typeof window && "undefined" != typeof document, M = ["Edge", "Trident", "Firefox"], j = 0, R = 0; R < M.length; R += 1)
        if (W && 0 <= navigator.userAgent.indexOf(M[R])) {
            j = 1;
            break
        }
    var I = W && window.Promise ? function(e) {
            var t = !1;
            return function() {
        ...
        Y = function() {
            ...
            return e = e.toString(), U.hasOwnProperty(e) || ("11" === e ? U[e] = -1 !== navigator.userAgent.indexOf("Trident") : "10" === e ? U[e] = -1 !== navigator.appVersion.indexOf("MSIE 10") : "all" === e && (U[e] = -1 !== navigator.userAgent.indexOf("Trident") || -1 !== navigator.userAgent.indexOf("MSIE")), U.all = U.all || Object.keys(U).some(function(e) {
                return U[e]
            })), U[e]
        },
        q = function() {
        ...
        Q = function() {
            function i(e, t) {
                ...
                })(this, i), this.scheduleUpdate = function() {
                    return requestAnimationFrame(n.update)
                }, this.update = I(this.update.bind(this)), this.options = z({}, i.Defaults, o), this.state = {
                    isDestroyed: !1,
                    isCreated: !1,
                    scrollParents: []
                }, this.reference = e && e.jquery ? e[0] : e, this.popper = t && t.jquery ? t[0] : t, this.options.modifiers = {}, Object.keys(z({}, i.Defaults.modifiers, o.modifiers)).forEach(function(e) {
                    n.options.modifiers[e] = z({}, i.Defaults.modifiers[e] || {}, o.modifiers ? o.modifiers[e] : {})
                ...
                value: function() {
                    return function() {
                        if (!this.state.isDestroyed) {
                            ...
                            e.offsets.reference = f(this.state, this.popper, this.reference, this.options.positionFixed), e.placement = a(this.options.placement, e.offsets.reference, this.popper, this.reference, this.options.modifiers.flip.boundariesElement, this.options.modifiers.flip.padding), e.originalPlacement = e.placement, e.positionFixed = this.options.positionFixed, e.offsets.popper = D(this.popper, e.offsets.reference, e.placement), e.offsets.popper.position = this.options.positionFixed ? "fixed" : "absolute", e = F(this.modifiers, e), this.state.isCreated ? this.options.onUpdate(e) : (this.state.isCreated = !0, this.options.onCreate(e))
                        }
                    }.call(this)
                }
            }, {
        ...
        modifiers: {
            ...
            offset: {
                ...
                fn: function(e, t) {
                    var n, o = t.offset,
                        ...
                        a = i.reference,
                        f = r.split("-")[0];
                    return n = A(+o) ? [+o, 0] : H(o, s, a, f), "left" === f ? (s.top += n[0], s.left -= n[1]) : "right" === f ? (s.top += n[0], s.left += n[1]) : "top" === f ? (s.left += n[0], s.top -= n[1]) : "bottom" === f && (s.left += n[0], s.top += n[1]), e.popper = s, e
                },
                offset: 0
            },
            preventOverflow: {
                ...
                fn: function(e, o) {
                    ...
                    var r = O(e.instance.popper, e.instance.reference, o.padding, t, e.positionFixed);
                    o.boundaries = r;
                    var n = o.priority,
                        i = e.offsets.popper,
                        s = {
                            primary: function(e) {
                                var t = i[e];
                                return i[e] < r[e] && !o.escapeWithReference && (t = C(i[e], r[e])), V({}, e, t)
                            },
                            secondary: function(e) {
                                var t = "right" === e ? "left" : "top",
                                    n = i[t];
                                return i[e] > r[e] && !o.escapeWithReference && (n = P(i[t], r[e] - ("right" === e ? i.width : i.height))), V({}, t, n)
                            }
                        };
            ...
            keepTogether: {
                ...
                fn: function(e) {
                    var t = e.offsets,
                        ...
                        f = s ? "left" : "top",
                        p = s ? "width" : "height";
                    return n[a] < i(o[f]) && (e.offsets.popper[f] = i(o[f]) - n[p]), n[f] > i(o[a]) && (e.offsets.popper[f] = i(o[a])), e
                }
            },
            arrow: {
                order: 500,
                ...
                fn: function(e, t) {
                    ...
                    var r = e.placement.split("-")[0],
                        ...
                        c = f ? "bottom" : "right",
                        h = L(o)[p];
                    a[c] - h < s[u] && (e.offsets.popper[u] -= s[u] - (a[c] - h)), a[u] + h > s[c] && (e.offsets.popper[u] += a[u] + h - s[c]), e.offsets.popper = E(e.offsets.popper);
                    var m = a[u] + a[p] / 2 - h / 2,
                        g = y(e.instance.popper),
                        v = parseFloat(g["margin" + l], 10),
                        b = parseFloat(g["border" + l + "Width"], 10),
                        w = m - e.offsets.popper[u] - v - b;
                    return w = C(P(s[p] - h, w), 0), e.arrowElement = o, e.offsets.arrow = (V(n = {}, u, Math.round(w)), V(n, d, ""), n), e
                },
                element: "[x-arrow]"
            },
            flip: {
                ...
                fn: function(h, m) {
                    ...
                    var g = O(h.instance.popper, h.instance.reference, m.padding, m.boundariesElement, h.positionFixed),
                    ...
                    return y.forEach(function(e, t) {
                        ...
                        var n, o = h.offsets.popper,
                            ...
                            a = i(o.left) < i(g.left),
                            f = i(o.right) > i(g.right),
                            p = i(o.top) < i(g.top),
                            l = i(o.bottom) > i(g.bottom),
                            u = "left" === v && a || "right" === v && f || "top" === v && p || "bottom" === v && l,
                            d = -1 !== ["top", "bottom"].indexOf(v),
                            c = !!m.flipVariations && (d && "start" === w && a || d && "end" === w && f || !d && "start" === w && p || !d && "end" === w && l);
                        (s || u || c) && (h.flipped = !0, (s || u) && (v = y[t + 1]), c && (w = "end" === (n = w) ? "start" : "start" === n ? "end" : n), h.placement = v + (w ? "-" + w : ""), h.offsets.popper = z({}, h.offsets.popper, D(h.instance.popper, h.offsets.reference, h.placement)), h = F(h.instance.modifiers, h, "flip"))
                    }), h
                },
                behavior: "flip",
                padding: 5,
            ...
            inner: {
                ...
                fn: function(e) {
                    ...
                    return r[s ? "left" : "top"] = i[n] - (a ? r[s ? "width" : "height"] : 0), e.placement = T(t), e.offsets.popper = E(r), e
                }
            },
            hide: {
                order: 800,
                enabled: !0,
                fn: function(e) {
                    if (!S(e.instance.modifiers, "hide", "preventOverflow")) return e;
            ...
            computeStyle: {
                ...
                fn: function(e, t) {
                    ...
                    var s, a, f = void 0 === i ? t.gpuAcceleration : i,
                        p = w(b(e.instance.popper)),
                        l = {
                            position: r.position
                        },
                        u = {
                        ...
                        h = k("transform");
                    if (a = "bottom" == d ? -p.height + u.bottom : u.top, s = "right" == c ? -p.width + u.right : u.left, f && h) l[h] = "translate3d(" + s + "px, " + a + "px, 0)", l[d] = 0, l[c] = 0, l.willChange = "transform";
                    else {
                        var m = "bottom" == d ? -1 : 1,
                            g = "right" == c ? -1 : 1;
                        l[d] = a * m, l[c] = s * g, l.willChange = d + ", " + c
                    }
                    var v = {
...
! function(t, e) {
    ...
    g(document).on(L.CLICK_DATA_API, "[data-slide], [data-slide-to]", x._dataApiClickHandler), g(window).on(L.LOAD_DATA_API, function() {
        for (var t = [].slice.call(document.querySelectorAll('[data-ride="carousel"]')), e = 0, n = t.length; e < n; e++) {
            var i = g(t[e]);
            x._jQueryInterface.call(i, i.data())
        }
    }), g.fn[b] = x._jQueryInterface, g.fn[b].Constructor = x, g.fn[b].noConflict = function() {
        return g.fn[b] = A, x._jQueryInterface
    };
    var F = "collapse",
        U = "bs.collapse",
        W = "." + U,
        ...
        $ = function() {
            ...
            return t.toggle = function() {
                ...
                if (!(this._isTransitioning || g(this._element).hasClass(B) || (this._parent && 0 === (t = [].slice.call(this._parent.querySelectorAll(".show, .collapsing")).filter(function(t) {
                    ...
                    })).length && (t = null), t && (e = g(t).not(this._selector).data(U)) && e._isTransitioning))) {
                    var i = g.Event(Q.SHOW);
                    if (g(this._element).trigger(i), !i.isDefaultPrevented()) {
                        t && (a._jQueryInterface.call(g(t).not(this._selector), "hide"), e || g(t).data(U, null));
                        var o = this._getDimension();
                        g(this._element).removeClass(V).addClass(Y), this._element.style[o] = 0, this._triggerArray.length && g(this._triggerArray).removeClass(z).attr("aria-expanded", !0), this.setTransitioning(!0);
                        ...
                        if (0 < i)
                            for (var o = 0; o < i; o++) {
                                var r = this._triggerArray[o],
                                    s = _.getSelectorFromElement(r);
                                null !== s && (g([].slice.call(document.querySelectorAll(s))).hasClass(B) || g(r).addClass(z).attr("aria-expanded", !1))
                            }
                ...
                g.removeData(this._element, U), this._config = null, this._parent = null, this._element = null, this._triggerArray = null, this._isTransitioning = null
            }, t._getConfig = function(t) {
                return (t = l({}, M, t)).toggle = Boolean(t.toggle), _.typeCheckConfig(F, t, K), t
                ...
                e.length && g(e).toggleClass(z, !n).attr("aria-expanded", n)
    ...
    g(document).on(Q.CLICK_DATA_API, X, function(t) {
        ...
        g(i).each(function() {
            var t = g(this),
                e = t.data(U) ? "toggle" : n.data();
            $._jQueryInterface.call(t, e)
        })
    }), g.fn[F] = $._jQueryInterface, g.fn[F].Constructor = $, g.fn[F].noConflict = function() {
        return g.fn[F] = q, $._jQueryInterface
    };
    var G = "dropdown",
        J = "bs.dropdown",
        Z = "." + J,
        ...
        it = {
            ...
            SHOWN: "shown" + Z,
            CLICK: "click" + Z,
            CLICK_DATA_API: "click" + Z + tt,
            KEYDOWN_DATA_API: "keydown" + Z + tt,
            KEYUP_DATA_API: "keyup" + Z + tt
        },
        ot = "disabled",
        rt = "show",
        ...
        ut = function() {
            ...
            return t.toggle = function() {
                ...
                return t = l({}, this.constructor.Default, g(this._element).data(), t), _.typeCheckConfig(G, t, this.constructor.DefaultType), t
                ...
                return this.each(function() {
                    var t = g(this).data(J);
                    if (t || (t = new c(this, "object" == typeof e ? e : null), g(this).data(J, t)), "string" == typeof e) {
    ...
    g(document).on(it.KEYDOWN_DATA_API, at, ut._dataApiKeydownHandler).on(it.KEYDOWN_DATA_API, lt, ut._dataApiKeydownHandler).on(it.CLICK_DATA_API + " " + it.KEYUP_DATA_API, ut._clearMenus).on(it.CLICK_DATA_API, at, function(t) {
        ...
        t.stopPropagation()
    }), g.fn[G] = ut._jQueryInterface, g.fn[G].Constructor = ut, g.fn[G].noConflict = function() {
        return g.fn[G] = et, ut._jQueryInterface
    };
    var ft = "modal",
        dt = "bs.modal",
        gt = "." + dt,
        ...
        bt = function() {
            ...
            return t.toggle = function(t) {
                ...
                this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE || document.body.appendChild(this._element), this._element.style.display = "block", this._element.removeAttribute("aria-hidden"), this._element.setAttribute("aria-modal", !0), g(this._dialog).hasClass("modal-dialog-scrollable") ? this._dialog.querySelector(".modal-body").scrollTop = 0 : this._element.scrollTop = 0, n && _.reflow(this._element), g(this._element).addClass(Ct), this._config.focus && this._enforceFocus();
        ...
        for (var n = (new window.DOMParser).parseFromString(t, "text/html"), a = Object.keys(s), l = [].slice.call(n.body.querySelectorAll("*")), i = function(t, e) {
                ...
                o.forEach(function(t) {
                    (function(t, e) {
                        ...
                        if (-1 !== e.indexOf(n)) return -1 === It.indexOf(n) || Boolean(t.nodeValue.match(Dt) || t.nodeValue.match(wt));
            ...
            return t.enable = function() {
                ...
                if (this._isEnabled)
                    if (t) {
                        ...
                        if (g(this.getTipElement()).hasClass(Mt)) return void this._leave(null, this);
                ...
                if (this.isWithContent() && this._isEnabled) {
                    ...
                    }), g(o).addClass(Mt), "ontouchstart" in document.documentElement && g(document.body).children().on("mouseover", null, g.noop);
                    var c = function() {
                ...
                var e = this,
                    ...
                    o = function() {
                        e._hoverState !== Ut && n.parentNode && n.parentNode.removeChild(n), e._cleanTipClass(), e.element.removeAttribute("aria-describedby"), g(e.element).trigger(e.constructor.Event.HIDDEN), null !== e._popper && e._popper.destroy(), t && t()
                    };
                if (g(this.element).trigger(i), !i.isDefaultPrevented()) {
                    if (g(n).removeClass(Mt), "ontouchstart" in document.documentElement && g(document.body).children().off("mouseover", null, g.noop), this._activeTrigger.click = !1, this._activeTrigger[Qt] = !1, this._activeTrigger[Kt] = !1, g(this.tip).hasClass(qt)) {
                ...
                g(this.getTipElement()).addClass(Lt + "-" + t)
            }, t.getTipElement = function() {
                return this.tip = this.tip || g(this.config.template)[0], this.tip
            }, t.setContent = function() {
                var t = this.getTipElement();
                this.setElementContent(g(t.querySelectorAll(".tooltip-inner")), this.getTitle()), g(t).removeClass(qt + " " + Mt)
            }, t.setElementContent = function(t, e) {
                "object" != typeof e || !e.nodeType && !e.jquery ? this.config.html ? (this.config.sanitize && (e = At(e, this.config.whiteList, this.config.sanitizeFn)), t.html(e)) : t.text(e) : this.config.html ? g(e).parent().is(t) || t.empty().append(e) : t.text(g(e).text())
            }, t.getTitle = function() {
                ...
                this.config.trigger.split(" ").forEach(function(t) {
                    if ("click" === t) g(i.element).on(i.constructor.Event.CLICK, i.config.selector, function(t) {
                        ...
                        var e = t === Kt ? i.constructor.Event.MOUSEENTER : i.constructor.Event.FOCUSIN,
                            n = t === Kt ? i.constructor.Event.MOUSELEAVE : i.constructor.Event.FOCUSOUT;
                ...
                var n = this.constructor.DATA_KEY;
                (e = e || g(t.currentTarget).data(n)) || (e = new this.constructor(t.currentTarget, this._getDelegateConfig()), g(t.currentTarget).data(n, e)), t && (e._activeTrigger["focusout" === t.type ? Qt : Kt] = !1), e._isWithActiveTrigger() || (clearTimeout(e._timeout), e._hoverState = "out", e.config.delay && e.config.delay.hide ? e._timeout = setTimeout(function() {
                ...
                return Object.keys(e).forEach(function(t) {
                    ...
                    show: t.delay,
                    hide: t.delay
                }), "number" == typeof t.title && (t.title = t.title.toString()), "number" == typeof t.content && (t.content = t.content.toString()), _.typeCheckConfig(Nt, t, this.constructor.DefaultType), t.sanitize && (t.template = At(t.template, t.whiteList, t.sanitizeFn)), t
                ...
                return this.each(function() {
                    var t = g(this).data(Ot),
                        e = "object" == typeof n && n;
                    if ((t || !/dispose|hide/.test(n)) && (t || (t = new i(this, e), g(this).data(Ot, t)), "string" == typeof n)) {
                        if (void 0 === t[n]) throw new TypeError('No method named "' + n + '"');
                        t[n]()
                    }
                })
    ...
    g.fn[Nt] = Bt._jQueryInterface, g.fn[Nt].Constructor = Bt, g.fn[Nt].noConflict = function() {
        return g.fn[Nt] = Pt, Bt._jQueryInterface
    };
    var Vt = "popover",
        Yt = "bs.popover",
        zt = "." + Yt,
        ...
        ee = function(t) {
            ...
            return o.isWithContent = function() {
                ...
                g(this.getTipElement()).addClass($t + "-" + t)
                ...
                return this.each(function() {
                    var t = g(this).data(Yt),
                        e = "object" == typeof n ? n : null;
                    if ((t || !/dispose|hide/.test(n)) && (t || (t = new i(this, e), g(this).data(Yt, t)), "string" == typeof n)) {
                        if (void 0 === t[n]) throw new TypeError('No method named "' + n + '"');
                        t[n]()
                    }
                })
    ...
    g.fn[Vt] = ee._jQueryInterface, g.fn[Vt].Constructor = ee, g.fn[Vt].noConflict = function() {
        return g.fn[Vt] = Xt, ee._jQueryInterface
    };
    var ne = "scrollspy",
        ie = "bs.scrollspy",
        oe = "." + ie,
        ...
        ge = function() {
            function n(t, e) {
                var n = this;
                this._element = t, this._scrollElement = "BODY" === t.tagName ? window : t, this._config = this._getConfig(e), this._selector = this._config.target + " " + ue + "," + this._config.target + " " + fe + "," + this._config.target + " .dropdown-item", this._offsets = [], this._targets = [], this._activeTarget = null, this._scrollHeight = 0, g(this._scrollElement).on(le.SCROLL, function(t) {
                    return n._process(t)
            ...
            return t.refresh = function() {
                ...
                g.removeData(this._element, ie), g(this._scrollElement).off(oe), this._element = null, this._scrollElement = null, this._config = null, this._selector = null, this._offsets = null, this._targets = null, this._activeTarget = null, this._scrollHeight = null
            }, t._getConfig = function(t) {
                if ("string" != typeof(t = l({}, se, "object" == typeof t && t ? t : {})).target) {
                    var e = g(t.target).attr("id");
                    e || (e = _.getUID(ne), g(t.target).attr("id", e)), t.target = "#" + e
                }
                return _.typeCheckConfig(ne, t, ae), t
                ...
                n.hasClass("dropdown-item") ? (n.closest(".dropdown").find(".dropdown-toggle").addClass(ce), n.addClass(ce)) : (n.addClass(ce), n.parents(he).prev(ue + ", " + fe).addClass(ce), n.parents(he).prev(".nav-item").children(ue).addClass(ce)), g(this._scrollElement).trigger(le.ACTIVATE, {
                    relatedTarget: e
                })
            }, t._clear = function() {
                ...
                return this.each(function() {
                    ...
                    if (t || (t = new n(this, "object" == typeof e && e), g(this).data(ie, t)), "string" == typeof e) {
                        if (void 0 === t[e]) throw new TypeError('No method named "' + e + '"');
                        t[e]()
                    }
                })
    ...
    g(window).on(le.LOAD_DATA_API, function() {
        for (var t = [].slice.call(document.querySelectorAll('[data-spy="scroll"]')), e = t.length; e--;) {
            var n = g(t[e]);
            ge._jQueryInterface.call(n, n.data())
        }
    }), g.fn[ne] = ge._jQueryInterface, g.fn[ne].Constructor = ge, g.fn[ne].noConflict = function() {
        return g.fn[ne] = re, ge._jQueryInterface
    };
    var _e = "bs.tab",
        me = "." + _e,
        pe = g.fn.tab,
        ...
        Te = function() {
            ...
            return t.show = function() {
                var n = this;
                if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && g(this._element).hasClass(Ee) || g(this._element).hasClass("disabled"))) {
                    var t, i, e = g(this._element).closest(".nav, .list-group")[0],
                        o = _.getSelectorFromElement(this._element);
                    if (e) {
                        var r = "UL" === e.nodeName || "OL" === e.nodeName ? Ce : ye;
                        i = (i = g.makeArray(g(e).find(r)))[i.length - 1]
                    }
                    var s = g.Event(ve.HIDE, {
                            relatedTarget: this._element
                        }),
                        a = g.Event(ve.SHOW, {
                            relatedTarget: i
                ...
                g.removeData(this._element, _e), this._element = null
            }, t._activate = function(t, e, n) {
                var i = this,
                    o = (!e || "UL" !== e.nodeName && "OL" !== e.nodeName ? g(e).children(ye) : g(e).find(Ce))[0],
                ...
                if (e) {
                    ...
                    i && g(i).removeClass(Ee), "tab" === e.getAttribute("role") && e.setAttribute("aria-selected", !1)
                }
                if (g(t).addClass(Ee), "tab" === t.getAttribute("role") && t.setAttribute("aria-selected", !0), _.reflow(t), t.classList.contains("fade") && t.classList.add("show"), t.parentNode && g(t.parentNode).hasClass("dropdown-menu")) {
                ...
                return this.each(function() {
                    var t = g(this),
                        e = t.data(_e);
                    if (e || (e = new i(this), t.data(_e, e)), "string" == typeof n) {
    ...
    g(document).on(ve.CLICK_DATA_API, '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]', function(t) {
        t.preventDefault(), Te._jQueryInterface.call(g(this), "show")
    }), g.fn.tab = Te._jQueryInterface, g.fn.tab.Constructor = Te, g.fn.tab.noConflict = function() {
        return g.fn.tab = pe, Te._jQueryInterface
    };
    var Se = "toast",
        be = "bs.toast",
        Ie = "." + be,
        ...
        Pe = function() {
            ...
            return t.show = function() {
                var t = this;
                g(this._element).trigger(we.SHOW), this._config.animation && this._element.classList.add("fade");
                var e = function() {
                    t._element.classList.remove(Ne), t._element.classList.add(Ae), g(t._element).trigger(we.SHOWN), t._config.autohide && t.hide()
                };
                if (this._element.classList.remove("hide"), this._element.classList.add(Ne), this._config.animation) {
                    var n = _.getTransitionDurationFromElement(this._element);
                    g(this._element).one(_.TRANSITION_END, e).emulateTransitionEnd(n)
                } else e()
            }, t.hide = function(t) {
                var e = this;
                this._element.classList.contains(Ae) && (g(this._element).trigger(we.HIDE), t ? this._close() : this._timeout = setTimeout(function() {
                    e._close()
                }, this._config.delay))
            }, t.dispose = function() {
                clearTimeout(this._timeout), this._timeout = null, this._element.classList.contains(Ae) && this._element.classList.remove(Ae), g(this._element).off(we.CLICK_DISMISS), g.removeData(this._element, be), this._element = null, this._config = null
            }, t._getConfig = function(t) {
                return t = l({}, ke, g(this._element).data(), "object" == typeof t && t ? t : {}), _.typeCheckConfig(Se, t, this.constructor.DefaultType), t
            }, t._setListeners = function() {
                var t = this;
                g(this._element).on(we.CLICK_DISMISS, '[data-dismiss="toast"]', function() {
                    return t.hide(!0)
                })
            }, t._close = function() {
                var t = this,
                    e = function() {
                        t._element.classList.add("hide"), g(t._element).trigger(we.HIDDEN)
                    };
                ...
                return this.each(function() {
                    var t = g(this),
                        e = t.data(be);
                    if (e || (e = new i(this, "object" == typeof n && n), t.data(be, e)), "string" == typeof n) {
                        if (void 0 === e[n]) throw new TypeError('No method named "' + n + '"');
                        e[n](this)
                    }
                })
    ...
    g.fn[Se] = Pe._jQueryInterface, g.fn[Se].Constructor = Pe, g.fn[Se].noConflict = function() {
            return g.fn[Se] = De, Pe._jQueryInterface
        },
        function() {
        ...
        }(), t.Util = _, t.Alert = h, t.Button = S, t.Carousel = x, t.Collapse = $, t.Dropdown = ut, t.Modal = bt, t.Popover = ee, t.Scrollspy = ge, t.Tab = Te, t.Toast = Pe, t.Tooltip = Bt, Object.defineProperty(t, "__esModule", {
            value: !0
        })
});
! function(e) {
    ...
    function e() {
        this._curInst = null, this._keyEvent = !1, this._disabledInputs = [], this._datepickerShowing = !1, this._inDialog = !1, this._mainDivId = "ui-datepicker-div", this._inlineClass = "ui-datepicker-inline", this._appendClass = "ui-datepicker-append", this._triggerClass = "ui-datepicker-trigger", this._dialogClass = "ui-datepicker-dialog", this._disableClass = "ui-datepicker-disabled", this._unselectableClass = "ui-datepicker-unselectable", this._currentClass = "ui-datepicker-current-day", this._dayOverClass = "ui-datepicker-days-cell-over", this.regional = [], this.regional[""] = {
            ...
            autoSize: !1,
            disabled: !1
        }, w.extend(this._defaults, this.regional[""]), this.regional.en = w.extend(!0, {}, this.regional[""]), this.regional["en-US"] = w.extend(!0, {}, this.regional.en), this.dpDiv = i(w("<div id='" + this._mainDivId + "' class='ui-datepicker ui-widget ui-widget-content ui-helper-clearfix ui-corner-all'></div>"))
    }
    ...
    function n() {
        w.datepicker._isDisabledDatepicker(r.inline ? r.dpDiv.parent()[0] : r.input[0]) || (w(this).parents(".ui-datepicker-calendar").find("a").removeClass("ui-state-hover"), w(this).addClass("ui-state-hover"), -1 !== this.className.indexOf("ui-datepicker-prev") && w(this).addClass("ui-datepicker-prev-hover"), -1 !== this.className.indexOf("ui-datepicker-next") && w(this).addClass("ui-datepicker-next-hover"))
    }

    function d(e, t) {
        for (var i in w.extend(e, t), t) null == t[i] && (e[i] = t[i]);
        return e
    }
    w.ui = w.ui || {}, w.ui.version = "1.12.1";
    var s, r, a = 0,
        o = Array.prototype.slice;
    w.cleanData = (s = w.cleanData, function(e) {
        var t, i, a;
        for (a = 0; null != (i = e[a]); a++) try {
            (t = w._data(i, "events")) && t.remove && w(i).triggerHandler("remove")
        } catch (e) {}
        s(e)
    }), w.widget = function(e, i, t) {
        var a, s, n, r = {},
            o = e.split(".")[0],
            l = o + "-" + (e = e.split(".")[1]);
        return t || (t = i, i = w.Widget), w.isArray(t) && (t = w.extend.apply(null, [{}].concat(t))), w.expr[":"][l.toLowerCase()] = function(e) {
            return !!w.data(e, l)
        }, w[o] = w[o] || {}, a = w[o][e], s = w[o][e] = function(e, t) {
            return this._createWidget ? void(arguments.length && this._createWidget(e, t)) : new s(e, t)
        }, w.extend(s, a, {
            version: t.version,
            _proto: w.extend({}, t),
            _childConstructors: []
        }), (n = new i).options = w.widget.extend({}, n.options), w.each(t, function(t, n) {
            return w.isFunction(n) ? void(r[t] = function() {
                function a() {
                ...
                return function() {
                    var e, t = this._super,
                        i = this._superApply;
                    return this._super = a, this._superApply = s, e = n.apply(this, arguments), this._super = t, this._superApply = i, e
                }
            }()) : void(r[t] = n)
        }), s.prototype = w.widget.extend(n, {
            ...
            widgetName: e,
            widgetFullName: l
        }), a ? (w.each(a._childConstructors, function(e, t) {
            var i = t.prototype;
            w.widget(i.namespace + "." + i.widgetName, s, t._proto)
        }), delete a._childConstructors) : i._childConstructors.push(s), w.widget.bridge(e, s), s
    }, w.widget.extend = function(e) {
        for (var t, i, a = o.call(arguments, 1), s = 0, n = a.length; s < n; s++)
            for (t in a[s]) i = a[s][t], a[s].hasOwnProperty(t) && void 0 !== i && (e[t] = w.isPlainObject(i) ? w.isPlainObject(e[t]) ? w.widget.extend({}, e[t], i) : w.widget.extend({}, i) : i);
        return e
    }, w.widget.bridge = function(n, t) {
        ...
        w.fn[n] = function(i) {
            ...
            return e ? this.length || "instance" !== i ? this.each(function() {
                var e, t = w.data(this, r);
                return "instance" === i ? (s = t, !1) : t ? w.isFunction(t[i]) && "_" !== i.charAt(0) ? (e = t[i].apply(t, a)) !== t && void 0 !== e ? (s = e && e.jquery ? s.pushStack(e.get()) : e, !1) : void 0 : w.error("no such method '" + i + "' for " + n + " widget instance") : w.error("cannot call methods on " + n + " prior to initialization; attempted to call method '" + i + "'")
            }) : s = void 0 : (a.length && (i = w.widget.extend.apply(null, [i].concat(a))), this.each(function() {
                var e = w.data(this, r);
                e ? (e.option(i || {}), e._init && e._init()) : w.data(this, r, new t(i, this))
            })), s
        }
        ...
        _createWidget: function(e, t) {
            t = w(t || this.defaultElement || this)[0], this.element = w(t), this.uuid = a++, this.eventNamespace = "." + this.widgetName + this.uuid, this.bindings = w(), this.hoverable = w(), this.focusable = w(), this.classesElementLookup = {}, t !== this && (w.data(t, this.widgetFullName, this), this._on(!0, this.element, {
                remove: function(e) {
                    e.target === t && this.destroy()
                }
            }), this.document = w(t.style ? t.ownerDocument : t.document || t), this.window = w(this.document[0].defaultView || this.document[0].parentWindow)), this.options = w.widget.extend({}, this.options, this._getCreateOptions(), e), this._create(), this.options.disabled && this._setOptionDisabled(this.options.disabled), this._trigger("create", null, this._getCreateEventData()), this._init()
        },
        ...
        destroy: function() {
            var i = this;
            this._destroy(), w.each(this.classesElementLookup, function(e, t) {
                i._removeClass(t, e)
        ...
        option: function(e, t) {
            ...
            if ("string" == typeof e)
                if (n = {}, e = (i = e.split(".")).shift(), i.length) {
                    for (a = n[e] = w.widget.extend({}, this.options[e]), s = 0; i.length - 1 > s; s++) a[i[s]] = a[i[s]] || {}, a = a[i[s]];
        ...
        _setOptionClasses: function(e) {
            var t, i, a;
            for (t in e) a = this.classesElementLookup[t], e[t] !== this.options.classes[t] && a && a.length && (i = w(a.get()), this._removeClass(a, t), i.addClass(this._classes({
                element: i,
                keys: t,
                classes: e,
                add: !0
        ...
        _classes: function(s) {
            function e(e, t) {
                var i, a;
                for (a = 0; e.length > a; a++) i = r.classesElementLookup[e[a]] || w(), i = s.add ? w(w.unique(i.get().concat(s.element.get()))) : w(i.not(s.element).get()), r.classesElementLookup[e[a]] = i, n.push(e[a]), t && s.classes[e[a]] && n.push(s.classes[e[a]])
            }
            var n = [],
                r = this;
            return s = w.extend({
        ...
        _untrackClassesElement: function(i) {
            var a = this;
            w.each(a.classesElementLookup, function(e, t) {
                -1 !== w.inArray(i.target, t) && (a.classesElementLookup[e] = w(t.not(i.target).get()))
            })
        },
        ...
        _on: function(r, o, e) {
            var l, h = this;
            "boolean" != typeof r && (e = o, o = r, r = !1), e ? (o = l = w(o), this.bindings = this.bindings.add(o)) : (e = o, o = this.element, l = this.widget()), w.each(e, function(e, t) {
                function i() {
                    return r || !0 !== h.options.disabled && !w(this).hasClass("ui-state-disabled") ? ("string" == typeof t ? h[t] : t).apply(h, arguments) : void 0
                }
                "string" != typeof t && (i.guid = t.guid = t.guid || i.guid || w.guid++);
                var a = e.match(/^([\w:-]*)\s*(.*)$/),
                    s = a[1] + h.eventNamespace,
                    n = a[2];
                n ? l.on(s, n, i) : o.on(s, i)
            })
        },
        _off: function(e, t) {
            t = (t || "").split(" ").join(this.eventNamespace + " ") + this.eventNamespace, e.off(t).off(t), this.bindings = w(this.bindings.not(e).get()), this.focusable = w(this.focusable.not(e).get()), this.hoverable = w(this.hoverable.not(e).get())
        },
        _delay: function(e, t) {
            var i = this;
        ...
        _hoverable: function(e) {
            this.hoverable = this.hoverable.add(e), this._on(e, {
                mouseenter: function(e) {
                    this._addClass(w(e.currentTarget), null, "ui-state-hover")
                },
                mouseleave: function(e) {
                    this._removeClass(w(e.currentTarget), null, "ui-state-hover")
                }
            })
        },
        _focusable: function(e) {
            this.focusable = this.focusable.add(e), this._on(e, {
                focusin: function(e) {
                    this._addClass(w(e.currentTarget), null, "ui-state-focus")
                },
                focusout: function(e) {
                    this._removeClass(w(e.currentTarget), null, "ui-state-focus")
                }
            })
        },
        _trigger: function(e, t, i) {
            var a, s, n = this.options[e];
            if (i = i || {}, (t = w.Event(t)).type = (e === this.widgetEventPrefix ? e : this.widgetEventPrefix + e).toLowerCase(), t.target = this.element[0], s = t.originalEvent)
                for (a in s) a in t || (t[a] = s[a]);
            return this.element.trigger(t, i), !(w.isFunction(n) && !1 === n.apply(this.element[0], [t].concat(i)) || t.isDefaultPrevented())
        }
    }, w.each({
        show: "fadeIn",
        hide: "fadeOut"
    }, function(n, r) {
        w.Widget.prototype["_" + n] = function(t, e, i) {
            "string" == typeof e && (e = {
                effect: e
            });
            var a, s = e ? !0 === e || "number" == typeof e ? r : e.effect || r : n;
            "number" == typeof(e = e || {}) && (e = {
                duration: e
            }), a = !w.isEmptyObject(e), e.complete = i, e.delay && t.delay(e.delay), a && w.effects && w.effects.effect[s] ? t[n](e) : s !== n && t[s] ? t[s](e.duration, e.easing, i) : t.queue(function(e) {
                w(this)[n](), i && i.call(t[0]), e()
            })
        }
    }), w.widget, w.ui.keyCode = {
        BACKSPACE: 8,
        COMMA: 188,
        DELETE: 46,
        DOWN: 40,
        ...
        _attachDatepicker: function(e, t) {
            var i, a, s;
            a = "div" === (i = e.nodeName.toLowerCase()) || "span" === i, e.id || (this.uuid += 1, e.id = "dp" + this.uuid), (s = this._newInst(w(e), a)).settings = w.extend({}, t || {}), "input" === i ? this._connectDatepicker(e, s) : a && this._inlineDatepicker(e, s)
        },
        _newInst: function(e, t) {
            return {
                ...
                drawYear: 0,
                inline: t,
                dpDiv: t ? i(w("<div class='" + this._inlineClass + " ui-datepicker ui-widget ui-widget-content ui-helper-clearfix ui-corner-all'></div>")) : this.dpDiv
            }
        },
        _connectDatepicker: function(e, t) {
            var i = w(e);
            t.append = w([]), t.trigger = w([]), i.hasClass(this.markerClassName) || (this._attachments(i, t), i.addClass(this.markerClassName).on("keydown", this._doKeyDown).on("keypress", this._doKeyPress).on("keyup", this._doKeyUp), this._autoSize(t), w.data(e, "datepicker", t), t.settings.disabled && this._disableDatepicker(e))
        },
        _attachments: function(e, t) {
            var i, a, s, n = this._get(t, "appendText"),
                r = this._get(t, "isRTL");
            t.append && t.append.remove(), n && (t.append = w("<span class='" + this._appendClass + "'>" + n + "</span>"), e[r ? "before" : "after"](t.append)), e.off("focus", this._showDatepicker), t.trigger && t.trigger.remove(), ("focus" === (i = this._get(t, "showOn")) || "both" === i) && e.on("focus", this._showDatepicker), ("button" === i || "both" === i) && (a = this._get(t, "buttonText"), s = this._get(t, "buttonImage"), t.trigger = w(this._get(t, "buttonImageOnly") ? w("<img/>").addClass(this._triggerClass).attr({
                src: s,
                alt: a,
                title: a
            }) : w("<button type='button'></button>").addClass(this._triggerClass).html(s ? w("<img/>").attr({
                src: s,
                alt: a,
                title: a
            }) : a)), e[r ? "before" : "after"](t.trigger), t.trigger.on("click", function() {
        ...
        _autoSize: function(e) {
            if (this._get(e, "autoSize") && !e.inline) {
                ...
                r.match(/[DM]/) && (t = function(e) {
                    for (s = a = i = 0; e.length > s; s++) e[s].length > i && (i = e[s].length, a = s);
                    return a
        ...
        _inlineDatepicker: function(e, t) {
            var i = w(e);
            i.hasClass(this.markerClassName) || (i.addClass(this.markerClassName).append(t.dpDiv), w.data(e, "datepicker", t), this._setDate(t, this._getDefaultDate(t), !0), this._updateDatepicker(t), this._updateAlternate(t), t.settings.disabled && this._disableDatepicker(e), t.dpDiv.css("display", "block"))
        },
        _dialogDatepicker: function(e, t, i, a, s) {
            var n, r, o, l, h, u = this._dialogInst;
            return u || (this.uuid += 1, n = "dp" + this.uuid, this._dialogInput = w("<input type='text' id='" + n + "' style='position: absolute; top: -100px; width: 0px;'/>"), this._dialogInput.on("keydown", this._doKeyDown), w("body").append(this._dialogInput), (u = this._dialogInst = this._newInst(this._dialogInput, !1)).settings = {}, w.data(this._dialogInput[0], "datepicker", u)), d(u.settings, a || {}), t = t && t.constructor === Date ? this._formatDate(u, t) : t, this._dialogInput.val(t), this._pos = s ? s.length ? s : [s.pageX, s.pageY] : null, this._pos || (r = document.documentElement.clientWidth, o = document.documentElement.clientHeight, l = document.documentElement.scrollLeft || document.body.scrollLeft, h = document.documentElement.scrollTop || document.body.scrollTop, this._pos = [r / 2 - 100 + l, o / 2 - 150 + h]), this._dialogInput.css("left", this._pos[0] + 20 + "px").css("top", this._pos[1] + "px"), u.settings.onSelect = i, this._inDialog = !0, this.dpDiv.addClass(this._dialogClass), this._showDatepicker(this._dialogInput[0]), w.blockUI && w.blockUI(this.dpDiv), w.data(this._dialogInput[0], "datepicker", u), this
        },
        _destroyDatepicker: function(e) {
            var t, i = w(e),
                a = w.data(e, "datepicker");
            i.hasClass(this.markerClassName) && (t = e.nodeName.toLowerCase(), w.removeData(e, "datepicker"), "input" === t ? (a.append.remove(), a.trigger.remove(), i.removeClass(this.markerClassName).off("focus", this._showDatepicker).off("keydown", this._doKeyDown).off("keypress", this._doKeyPress).off("keyup", this._doKeyUp)) : ("div" === t || "span" === t) && i.removeClass(this.markerClassName).empty(), r === a && (r = null))
        },
        _enableDatepicker: function(t) {
            var e, i, a = w(t),
                s = w.data(t, "datepicker");
            a.hasClass(this.markerClassName) && ("input" === (e = t.nodeName.toLowerCase()) ? (t.disabled = !1, s.trigger.filter("button").each(function() {
                this.disabled = !1
            }).end().filter("img").css({
                opacity: "1.0",
                cursor: ""
            })) : ("div" === e || "span" === e) && ((i = a.children("." + this._inlineClass)).children().removeClass("ui-state-disabled"), i.find("select.ui-datepicker-month, select.ui-datepicker-year").prop("disabled", !1)), this._disabledInputs = w.map(this._disabledInputs, function(e) {
                return e === t ? null : e
            }))
        },
        _disableDatepicker: function(t) {
            var e, i, a = w(t),
                s = w.data(t, "datepicker");
            a.hasClass(this.markerClassName) && ("input" === (e = t.nodeName.toLowerCase()) ? (t.disabled = !0, s.trigger.filter("button").each(function() {
                this.disabled = !0
            }).end().filter("img").css({
                opacity: "0.5",
                cursor: "default"
            })) : ("div" === e || "span" === e) && ((i = a.children("." + this._inlineClass)).children().addClass("ui-state-disabled"), i.find("select.ui-datepicker-month, select.ui-datepicker-year").prop("disabled", !0)), this._disabledInputs = w.map(this._disabledInputs, function(e) {
                return e === t ? null : e
        ...
        _optionDatepicker: function(e, t, i) {
            ...
            return 2 === arguments.length && "string" == typeof t ? "defaults" === t ? w.extend({}, w.datepicker._defaults) : o ? "all" === t ? w.extend({}, o.settings) : this._get(o, t) : null : (a = t || {}, "string" == typeof t && ((a = {})[t] = i), void(o && (this._curInst === o && this._hideDatepicker(), s = this._getDateDatepicker(e, !0), n = this._getMinMaxDate(o, "min"), r = this._getMinMaxDate(o, "max"), d(o.settings, a), null !== n && void 0 !== a.dateFormat && void 0 === a.minDate && (o.settings.minDate = this._formatDate(o, n)), null !== r && void 0 !== a.dateFormat && void 0 === a.maxDate && (o.settings.maxDate = this._formatDate(o, r)), "disabled" in a && (a.disabled ? this._disableDatepicker(e) : this._enableDatepicker(e)), this._attachments(w(e), o), this._autoSize(o), this._setDate(o, s), this._updateAlternate(o), this._updateDatepicker(o))))
        },
        ...
        _doKeyDown: function(e) {
            var t, i, a, s = w.datepicker._getInst(e.target),
                n = !0,
                r = s.dpDiv.is(".ui-datepicker-rtl");
            if (s._keyEvent = !0, w.datepicker._datepickerShowing) switch (e.keyCode) {
                case 9:
                    w.datepicker._hideDatepicker(), n = !1;
                    break;
                case 13:
                    return (a = w("td." + w.datepicker._dayOverClass + ":not(." + w.datepicker._currentClass + ")", s.dpDiv))[0] && w.datepicker._selectDay(e.target, s.selectedMonth, s.selectedYear, a[0]), (t = w.datepicker._get(s, "onSelect")) ? (i = w.datepicker._formatDate(s), t.apply(s.input ? s.input[0] : null, [i, s])) : w.datepicker._hideDatepicker(), !1;
                case 27:
                    w.datepicker._hideDatepicker();
                    break;
                case 33:
                    w.datepicker._adjustDate(e.target, e.ctrlKey ? -w.datepicker._get(s, "stepBigMonths") : -w.datepicker._get(s, "stepMonths"), "M");
                    break;
                case 34:
                    w.datepicker._adjustDate(e.target, e.ctrlKey ? +w.datepicker._get(s, "stepBigMonths") : +w.datepicker._get(s, "stepMonths"), "M");
                    break;
                ...
                case 36:
                    ...
                    break;
                case 37:
                    (e.ctrlKey || e.metaKey) && w.datepicker._adjustDate(e.target, r ? 1 : -1, "D"), n = e.ctrlKey || e.metaKey, e.originalEvent.altKey && w.datepicker._adjustDate(e.target, e.ctrlKey ? -w.datepicker._get(s, "stepBigMonths") : -w.datepicker._get(s, "stepMonths"), "M");
                    break;
                case 38:
        ...
        _doKeyPress: function(e) {
            var t, i, a = w.datepicker._getInst(e.target);
            return w.datepicker._get(a, "constrainInput") ? (t = w.datepicker._possibleChars(w.datepicker._get(a, "dateFormat")), i = String.fromCharCode(null == e.charCode ? e.keyCode : e.charCode), e.ctrlKey || e.metaKey || i < " " || !t || -1 < t.indexOf(i)) : void 0
        },
        _doKeyUp: function(e) {
        ...
        _showDatepicker: function(e) {
            var t, i, a, s, n, r, o;
            ("input" !== (e = e.target || e).nodeName.toLowerCase() && (e = w("input", e.parentNode)[0]), w.datepicker._isDisabledDatepicker(e) || w.datepicker._lastInput === e) || (t = w.datepicker._getInst(e), w.datepicker._curInst && w.datepicker._curInst !== t && (w.datepicker._curInst.dpDiv.stop(!0, !0), t && w.datepicker._datepickerShowing && w.datepicker._hideDatepicker(w.datepicker._curInst.input[0])), !1 !== (a = (i = w.datepicker._get(t, "beforeShow")) ? i.apply(e, [e, t]) : {}) && (d(t.settings, a), t.lastVal = null, w.datepicker._lastInput = e, w.datepicker._setDateFromField(t), w.datepicker._inDialog && (e.value = ""), w.datepicker._pos || (w.datepicker._pos = w.datepicker._findPos(e), w.datepicker._pos[1] += e.offsetHeight), s = !1, w(e).parents().each(function() {
                return !(s |= "fixed" === w(this).css("position"))
            }), n = {
                ...
                display: "block",
                top: "-1000px"
            }), w.datepicker._updateDatepicker(t), n = w.datepicker._checkOffset(t, n, s), t.dpDiv.css({
                position: w.datepicker._inDialog && w.blockUI ? "static" : s ? "fixed" : "absolute",
                display: "none",
                left: n.left + "px",
                top: n.top + "px"
            }), t.inline || (r = w.datepicker._get(t, "showAnim"), o = w.datepicker._get(t, "duration"), t.dpDiv.css("z-index", function(e) {
                for (var t, i; e.length && e[0] !== document;) {
                    if (("absolute" === (t = e.css("position")) || "relative" === t || "fixed" === t) && (i = parseInt(e.css("zIndex"), 10), !isNaN(i) && 0 !== i)) return i;
                    e = e.parent()
                }
                return 0
            }(w(e)) + 1), w.datepicker._datepickerShowing = !0, w.effects && w.effects.effect[r] ? t.dpDiv.show(r, w.datepicker._get(t, "showOptions"), o) : t.dpDiv[r || "show"](r ? o : null), w.datepicker._shouldFocusInput(t) && t.input.trigger("focus"), w.datepicker._curInst = t)))
        },
        _updateDatepicker: function(e) {
            ...
            0 < s.length && n.apply(s.get(0)), e.dpDiv.removeClass("ui-datepicker-multi-2 ui-datepicker-multi-3 ui-datepicker-multi-4").width(""), 1 < a && e.dpDiv.addClass("ui-datepicker-multi-" + a).css("width", 17 * a + "em"), e.dpDiv[(1 !== i[0] || 1 !== i[1] ? "add" : "remove") + "Class"]("ui-datepicker-multi"), e.dpDiv[(this._get(e, "isRTL") ? "add" : "remove") + "Class"]("ui-datepicker-rtl"), e === w.datepicker._curInst && w.datepicker._datepickerShowing && w.datepicker._shouldFocusInput(e) && e.input.trigger("focus"), e.yearshtml && (t = e.yearshtml, setTimeout(function() {
        ...
        _checkOffset: function(e, t, i) {
            var a = e.dpDiv.outerWidth(),
                ...
                o = document.documentElement.clientWidth + (i ? 0 : w(document).scrollLeft()),
                l = document.documentElement.clientHeight + (i ? 0 : w(document).scrollTop());
            return t.left -= this._get(e, "isRTL") ? a - n : 0, t.left -= i && t.left === e.input.offset().left ? w(document).scrollLeft() : 0, t.top -= i && t.top === e.input.offset().top + r ? w(document).scrollTop() : 0, t.left -= Math.min(t.left, t.left + a > o && a < o ? Math.abs(t.left + a - o) : 0), t.top -= Math.min(t.top, t.top + s > l && s < l ? Math.abs(s + r) : 0), t
        },
        _findPos: function(e) {
            for (var t, i = this._getInst(e), a = this._get(i, "isRTL"); e && ("hidden" === e.type || 1 !== e.nodeType || w.expr.filters.hidden(e));) e = e[a ? "previousSibling" : "nextSibling"];
            return [(t = w(e).offset()).left, t.top]
        },
        _hideDatepicker: function(e) {
            var t, i, a, s, n = this._curInst;
            !n || e && n !== w.data(e, "datepicker") || this._datepickerShowing && (t = this._get(n, "showAnim"), i = this._get(n, "duration"), a = function() {
                w.datepicker._tidyDialog(n)
            }, w.effects && (w.effects.effect[t] || w.effects[t]) ? n.dpDiv.hide(t, w.datepicker._get(n, "showOptions"), i, a) : n.dpDiv["slideDown" === t ? "slideUp" : "fadeIn" === t ? "fadeOut" : "hide"](t ? i : null, a), t || a(), this._datepickerShowing = !1, (s = this._get(n, "onClose")) && s.apply(n.input ? n.input[0] : null, [n.input ? n.input.val() : "", n]), this._lastInput = null, this._inDialog && (this._dialogInput.css({
                position: "absolute",
                left: "0",
                top: "-100px"
        ...
        _checkExternalClick: function(e) {
            if (w.datepicker._curInst) {
                var t = w(e.target),
                    i = w.datepicker._getInst(t[0]);
                (t[0].id !== w.datepicker._mainDivId && 0 === t.parents("#" + w.datepicker._mainDivId).length && !t.hasClass(w.datepicker.markerClassName) && !t.closest("." + w.datepicker._triggerClass).length && w.datepicker._datepickerShowing && (!w.datepicker._inDialog || !w.blockUI) || t.hasClass(w.datepicker.markerClassName) && w.datepicker._curInst !== i) && w.datepicker._hideDatepicker()
            }
        },
        ...
        _gotoToday: function(e) {
            var t, i = w(e),
                a = this._getInst(i[0]);
            this._get(a, "gotoCurrent") && a.currentDay ? (a.selectedDay = a.currentDay, a.drawMonth = a.selectedMonth = a.currentMonth, a.drawYear = a.selectedYear = a.currentYear) : (t = new Date, a.selectedDay = t.getDate(), a.drawMonth = a.selectedMonth = t.getMonth(), a.drawYear = a.selectedYear = t.getFullYear()), this._notifyChange(a), this._adjustDate(i)
        },
        ...
        _selectDay: function(e, t, i, a) {
            var s, n = w(e);
            w(a).hasClass(this._unselectableClass) || this._isDisabledDatepicker(n[0]) || ((s = this._getInst(n[0])).selectedDay = s.currentDay = w("a", a).html(), s.selectedMonth = s.currentMonth = t, s.selectedYear = s.currentYear = i, this._selectDate(e, this._formatDate(s, s.currentDay, s.currentMonth, s.currentYear)))
        },
        ...
        _updateAlternate: function(e) {
            ...
            s && (t = this._get(e, "altFormat") || this._get(e, "dateFormat"), i = this._getDate(e), a = this.formatDate(t, i, this._getFormatConfig(e)), w(s).val(a))
        },
            ...
            var a, t, s, r, o = 0,
                ...
                y = function(e, t, i) {
                    ...
                    if (w.each(s, function(e, t) {
                            var i = t[1];
                            return n.substr(o, i.length).toLowerCase() === i.toLowerCase() ? (a = t[0], o += i.length, !1) : void 0
                        }), -1 !== a) return a + 1;
                    throw "Unknown name at position " + o
                },
                M = function() {
                    if (n.charAt(o) !== i.charAt(a)) throw "Unexpected literal at position " + o;
                    o++
                };
            for (a = 0; i.length > a; a++)
                if (v) "'" !== i.charAt(a) || k("'") ? M() : v = !1;
                    ...
                    case "y":
                        ...
                        break;
                    case "@":
                        g = (r = new Date(D("@"))).getFullYear(), _ = r.getMonth() + 1, f = r.getDate();
                        break;
                    case "!":
                        g = (r = new Date((D("!") - this._ticksTo1970) / 1e4)).getFullYear(), _ = r.getMonth() + 1, f = r.getDate();
                        break;
                    case "'":
                        k("'") ? M() : v = !0;
                        break;
                ...
                if (n.length > o && (s = n.substr(o), !/^\s+/.test(s))) throw "Extra/unparsed characters found in date: " + s;
            if (-1 === g ? g = (new Date).getFullYear() : g < 100 && (g += (new Date).getFullYear() - (new Date).getFullYear() % 100 + (g <= h ? 0 : -100)), -1 < m)
                for (_ = 1, f = m; !(f <= (t = this._getDaysInMonth(g, _ - 1)));) _++, f -= t;
            if ((r = this._daylightSavingAdjust(new Date(g, _ - 1, f))).getFullYear() !== g || r.getMonth() + 1 !== _ || r.getDate() !== f) throw "Invalid date";
            return r
        },
        ATOM: "yy-mm-dd",
        COOKIE: "D, dd M yy",
        ...
        formatDate: function(i, e, t) {
            ...
            if (e)
                for (a = 0; i.length > a; a++)
                    if (c) "'" !== i.charAt(a) || l("'") ? d += i.charAt(a) : c = !1;
                    else switch (i.charAt(a)) {
                        case "d":
                            d += h("d", e.getDate(), 2);
                            break;
        ...
        _possibleChars: function(i) {
            ...
            for (a = 0; i.length > a; a++)
                if (t) "'" !== i.charAt(a) || s("'") ? e += i.charAt(a) : t = !1;
                else switch (i.charAt(a)) {
                    case "d":
                    case "m":
                    case "y":
        ...
        _determineDate: function(o, e, t) {
            var i, a, s = null == e || "" === e ? t : "string" == typeof e ? function(e) {
                try {
                    return w.datepicker.parseDate(w.datepicker._get(o, "dateFormat"), e, w.datepicker._getFormatConfig(o))
                } catch (e) {}
                for (var t = (e.toLowerCase().match(/^c/) ? w.datepicker._getDate(o) : null) || new Date, i = t.getFullYear(), a = t.getMonth(), s = t.getDate(), n = /([+\-]?[0-9]+)\s*(d|D|w|W|m|M|y|Y)?/g, r = n.exec(e); r;) {
                    switch (r[2] || "d") {
                        case "d":
                        case "D":
                            s += parseInt(r[1], 10);
                        ...
                        case "m":
                        case "M":
                            a += parseInt(r[1], 10), s = Math.min(s, w.datepicker._getDaysInMonth(i, a));
                            break;
                        case "y":
                        case "Y":
                            i += parseInt(r[1], 10), s = Math.min(s, w.datepicker._getDaysInMonth(i, a))
                    }
                    r = n.exec(e)
                }
        ...
        _attachHandlers: function(e) {
            ...
            e.dpDiv.find("[data-handler]").map(function() {
                var e = {
                    prev: function() {
                        w.datepicker._adjustDate(i, -t, "M")
                    },
                    next: function() {
                        w.datepicker._adjustDate(i, +t, "M")
                    },
                    ...
                    today: function() {
                        w.datepicker._gotoToday(i)
                    },
                    selectDay: function() {
                        return w.datepicker._selectDay(i, +this.getAttribute("data-month"), +this.getAttribute("data-year"), this), !1
                    },
                    selectMonth: function() {
                        return w.datepicker._selectMonthYear(i, this, "M"), !1
                    },
                    selectYear: function() {
                        return w.datepicker._selectMonthYear(i, this, "Y"), !1
                    }
                };
                w(this).on(this.getAttribute("data-event"), e[this.getAttribute("data-handler")])
            })
        },
        _generateHTML: function(e) {
            var t, i, a, s, n, r, o, l, h, u, d, c, p, g, _, f, m, v, k, D, y, M, w, b, C, x, I, N, S, A, F, O, Y, T, E, j, K, P, W, V = new Date,
                L = this._daylightSavingAdjust(new Date(V.getFullYear(), V.getMonth(), V.getDate())),
                R = this._get(e, "isRTL"),
            ...
            for (e.drawMonth = Z, e.drawYear = ee, i = this._get(e, "prevText"), i = z ? this.formatDate(i, this._daylightSavingAdjust(new Date(ee, Z - q, 1)), this._getFormatConfig(e)) : i, a = this._canAdjustMonth(e, -1, ee, Z) ? "<a class='ui-datepicker-prev ui-corner-all' data-handler='prev' data-event='click' title='" + i + "'><span class='ui-icon ui-icon-circle-triangle-" + (R ? "e" : "w") + "'>" + i + "</span></a>" : U ? "" : "<a class='ui-datepicker-prev ui-corner-all ui-state-disabled' title='" + i + "'><span class='ui-icon ui-icon-circle-triangle-" + (R ? "e" : "w") + "'>" + i + "</span></a>", s = this._get(e, "nextText"), s = z ? this.formatDate(s, this._daylightSavingAdjust(new Date(ee, Z + q, 1)), this._getFormatConfig(e)) : s, n = this._canAdjustMonth(e, 1, ee, Z) ? "<a class='ui-datepicker-next ui-corner-all' data-handler='next' data-event='click' title='" + s + "'><span class='ui-icon ui-icon-circle-triangle-" + (R ? "w" : "e") + "'>" + s + "</span></a>" : U ? "" : "<a class='ui-datepicker-next ui-corner-all ui-state-disabled' title='" + s + "'><span class='ui-icon ui-icon-circle-triangle-" + (R ? "w" : "e") + "'>" + s + "</span></a>", r = this._get(e, "currentText"), o = this._get(e, "gotoCurrent") && e.currentDay ? X : L, r = z ? this.formatDate(r, o, this._getFormatConfig(e)) : r, l = e.inline ? "" : "<button type='button' class='ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all' data-handler='hide' data-event='click'>" + this._get(e, "closeText") + "</button>", h = H ? "<div class='ui-datepicker-buttonpane ui-widget-content'>" + (R ? l : "") + (this._isInRange(e, o) ? "<button type='button' class='ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all' data-handler='today' data-event='click'>" + r + "</button>" : "") + (R ? "" : l) + "</div>" : "", u = parseInt(this._get(e, "firstDay"), 10), u = isNaN(u) ? 0 : u, d = this._get(e, "showWeek"), c = this._get(e, "dayNames"), p = this._get(e, "dayNamesMin"), g = this._get(e, "monthNames"), _ = this._get(e, "monthNamesShort"), f = this._get(e, "beforeShowDay"), m = this._get(e, "showOtherMonths"), v = this._get(e, "selectOtherMonths"), k = this._getDefaultDate(e), D = "", M = 0; B[0] > M; M++) {
                for (w = "", this.maxRows = 4, b = 0; B[1] > b; b++) {
                    ...
                    for (I += "<div class='ui-datepicker-header ui-widget-header ui-helper-clearfix" + x + "'>" + (/all|left/.test(x) && 0 === M ? R ? n : a : "") + (/all|right/.test(x) && 0 === M ? R ? a : n : "") + this._generateMonthYearHeader(e, Z, ee, $, Q, 0 < M || 0 < b, g, _) + "</div><table class='ui-datepicker-calendar'><thead><tr>", N = d ? "<th class='ui-datepicker-week-col'>" + this._get(e, "weekHeader") + "</th>" : "", y = 0; y < 7; y++) N += "<th scope='col'" + (5 <= (y + u + 6) % 7 ? " class='ui-datepicker-week-end'" : "") + "><span title='" + c[S = (y + u) % 7] + "'>" + p[S] + "</span></th>";
                    for (I += N + "</tr></thead><tbody>", A = this._getDaysInMonth(ee, Z), ee === e.selectedYear && Z === e.selectedMonth && (e.selectedDay = Math.min(e.selectedDay, A)), F = (this._getFirstDayOfMonth(ee, Z) - u + 7) % 7, O = Math.ceil((F + A) / 7), Y = J && this.maxRows > O ? this.maxRows : O, this.maxRows = Y, T = this._daylightSavingAdjust(new Date(ee, Z, 1 - F)), E = 0; E < Y; E++) {
                        for (I += "<tr>", j = d ? "<td class='ui-datepicker-week-col'>" + this._get(e, "calculateWeek")(T) + "</td>" : "", y = 0; y < 7; y++) K = f ? f.apply(e.input ? e.input[0] : null, [T]) : [!0, ""], W = (P = T.getMonth() !== Z) && !v || !K[0] || $ && T < $ || Q && Q < T, j += "<td class='" + (5 <= (y + u + 6) % 7 ? " ui-datepicker-week-end" : "") + (P ? " ui-datepicker-other-month" : "") + (T.getTime() === C.getTime() && Z === e.selectedMonth && e._keyEvent || k.getTime() === T.getTime() && k.getTime() === C.getTime() ? " " + this._dayOverClass : "") + (W ? " " + this._unselectableClass + " ui-state-disabled" : "") + (P && !m ? "" : " " + K[1] + (T.getTime() === X.getTime() ? " " + this._currentClass : "") + (T.getTime() === L.getTime() ? " ui-datepicker-today" : "")) + "'" + (P && !m || !K[2] ? "" : " title='" + K[2].replace(/'/g, "&#39;") + "'") + (W ? "" : " data-handler='selectDay' data-event='click' data-month='" + T.getMonth() + "' data-year='" + T.getFullYear() + "'") + ">" + (P && !m ? "&#xa0;" : W ? "<span class='ui-state-default'>" + T.getDate() + "</span>" : "<a class='ui-state-default" + (T.getTime() === L.getTime() ? " ui-state-highlight" : "") + (T.getTime() === X.getTime() ? " ui-state-active" : "") + (P ? " ui-priority-secondary" : "") + "' href='#'>" + T.getDate() + "</a>") + "</td>", T.setDate(T.getDate() + 1), T = this._daylightSavingAdjust(T);
                        I += j + "</tr>"
                    }
                    11 < ++Z && (Z = 0, ee++), w += I += "</tbody></table>" + (J ? "</div>" + (0 < B[0] && b === B[1] - 1 ? "<div class='ui-datepicker-row-break'></div>" : "") : "")
                }
                D += w
            }
            return D += h, e._keyEvent = !1, D
        },
        _generateMonthYearHeader: function(e, t, i, a, s, n, r, o) {
            var l, h, u, d, c, p, g, _, f = this._get(e, "changeMonth"),
                m = this._get(e, "changeYear"),
                v = this._get(e, "showMonthAfterYear"),
                k = "<div class='ui-datepicker-title'>",
                D = "";
            if (n || !f) D += "<span class='ui-datepicker-month'>" + r[t] + "</span>";
            else {
                for (l = a && a.getFullYear() === i, h = s && s.getFullYear() === i, D += "<select class='ui-datepicker-month' data-handler='selectMonth' data-event='change'>", u = 0; u < 12; u++)(!l || u >= a.getMonth()) && (!h || s.getMonth() >= u) && (D += "<option value='" + u + "'" + (u === t ? " selected='selected'" : "") + ">" + o[u] + "</option>");
                D += "</select>"
            }
            if (v || (k += D + (!n && f && m ? "" : "&#xa0;")), !e.yearshtml)
                if (e.yearshtml = "", n || !m) k += "<span class='ui-datepicker-year'>" + i + "</span>";
                else {
                    for (d = this._get(e, "yearRange").split(":"), c = (new Date).getFullYear(), g = (p = function(e) {
                            var t = e.match(/c[+\-].*/) ? i + parseInt(e.substring(1), 10) : e.match(/[+\-].*/) ? c + parseInt(e, 10) : parseInt(e, 10);
                            return isNaN(t) ? c : t
                        })(d[0]), _ = Math.max(g, p(d[1] || "")), g = a ? Math.max(g, a.getFullYear()) : g, _ = s ? Math.min(_, s.getFullYear()) : _, e.yearshtml += "<select class='ui-datepicker-year' data-handler='selectYear' data-event='change'>"; g <= _; g++) e.yearshtml += "<option value='" + g + "'" + (g === i ? " selected='selected'" : "") + ">" + g + "</option>";
                    e.yearshtml += "</select>", k += e.yearshtml, e.yearshtml = null
                }
            return k += this._get(e, "yearSuffix"), v && (k += (!n && f && m ? "" : "&#xa0;") + D), k + "</div>"
        },
        ...
        _isInRange: function(e, t) {
            ...
            return l && (i = l.split(":"), a = (new Date).getFullYear(), r = parseInt(i[0], 10), o = parseInt(i[1], 10), i[0].match(/[+\-].*/) && (r += a), i[1].match(/[+\-].*/) && (o += a)), (!s || t.getTime() >= s.getTime()) && (!n || t.getTime() <= n.getTime()) && (!r || t.getFullYear() >= r) && (!o || o >= t.getFullYear())
        },
        ...
        w.datepicker.initialized || (w(document).on("mousedown", w.datepicker._checkExternalClick), w.datepicker.initialized = !0), 0 === w("#" + w.datepicker._mainDivId).length && w("body").append(w.datepicker.dpDiv);
        ...
        }) : w.datepicker["_" + e + "Datepicker"].apply(w.datepicker, [this[0]].concat(t))
    }, w.datepicker = new e, w.datepicker.initialized = !1, w.datepicker.uuid = (new Date).getTime(), w.datepicker.version = "1.12.1", w.datepicker, w.ui.ie = !!/msie [\w.]+/.exec(navigator.userAgent.toLowerCase());
    var l = !1;
    w(document).on("mouseup", function() {
        ...
        _mouseInit: function() {
            ...
            this.element.on("mousedown." + this.widgetName, function(e) {
                ...
                return !0 === w.data(e.target, t.widgetName + ".preventClickEvent") ? (w.removeData(e.target, t.widgetName + ".preventClickEvent"), e.stopImmediatePropagation(), !1) : void 0
            }), this.started = !1
        },
        ...
        _mouseDown: function(e) {
            if (!l) {
                ...
                var t = this,
                    i = 1 === e.which,
                    a = !("string" != typeof this.options.cancel || !e.target.nodeName) && w(e.target).closest(this.options.cancel).length;
                return i && !a && this._mouseCapture(e) && (this.mouseDelayMet = !this.options.delay, this.mouseDelayMet || (this._mouseDelayTimer = setTimeout(function() {
                    t.mouseDelayMet = !0
                }, this.options.delay)), this._mouseDistanceMet(e) && this._mouseDelayMet(e) && (this._mouseStarted = !1 !== this._mouseStart(e), !this._mouseStarted) ? e.preventDefault() : (!0 === w.data(e.target, this.widgetName + ".preventClickEvent") && w.removeData(e.target, this.widgetName + ".preventClickEvent"), this._mouseMoveDelegate = function(e) {
        ...
        _mouseMove: function(e) {
            if (this._mouseMoved) {
                if (w.ui.ie && (!document.documentMode || document.documentMode < 9) && !e.button) return this._mouseUp(e);
                if (!e.which)
        ...
        _mouseUp: function(e) {
            this.document.off("mousemove." + this.widgetName, this._mouseMoveDelegate).off("mouseup." + this.widgetName, this._mouseUpDelegate), this._mouseStarted && (this._mouseStarted = !1, e.target === this._mouseDownEvent.target && w.data(e.target, this.widgetName + ".preventClickEvent", !0), this._mouseStop(e)), this._mouseDelayTimer && (clearTimeout(this._mouseDelayTimer), delete this._mouseDelayTimer), this.ignoreMissingWhich = !1, l = !1, e.preventDefault()
        },
        ...
        _createHandles: function() {
            var e, t, i = this.options,
                ...
                s = [];
            for (t = i.values && i.values.length || 1, a.length > t && (a.slice(t).remove(), a = a.slice(0, t)), e = a.length; e < t; e++) s.push("<span tabindex='0'></span>");
            this.handles = a.add(w(s.join("")).appendTo(this.element)), this._addClass(this.handles, "ui-slider-handle", "ui-state-default"), this.handle = this.handles.eq(0), this.handles.each(function(e) {
                w(this).data("ui-slider-handle-index", e).attr("tabIndex", 0)
            })
        },
        _createRange: function() {
            var e = this.options;
            e.range ? (!0 === e.range && (e.values ? e.values.length && 2 !== e.values.length ? e.values = [e.values[0], e.values[0]] : w.isArray(e.values) && (e.values = e.values.slice(0)) : e.values = [this._valueMin(), this._valueMin()]), this.range && this.range.length ? (this._removeClass(this.range, "ui-slider-range-min ui-slider-range-max"), this.range.css({
                left: "",
                bottom: ""
            })) : (this.range = w("<div>").appendTo(this.element), this._addClass(this.range, "ui-slider-range")), ("min" === e.range || "max" === e.range) && this._addClass(this.range, "ui-slider-range-" + e.range)) : (this.range && this.range.remove(), this.range = null)
        },
        ...
        _mouseCapture: function(e) {
            ...
            return !h.disabled && (this.elementSize = {
                ...
                (t < a || a === t && (e === l._lastChangedValue || l.values(e) === h.min)) && (a = t, s = w(this), n = e)
            }), !1 !== this._start(e, n) && (this._mouseSliding = !0, this._handleIndex = n, this._addClass(s, null, "ui-state-active"), s.trigger("focus"), r = s.offset(), o = !w(e.target).parents().addBack().is(".ui-slider-handle"), this._clickOffset = o ? {
                left: 0,
                top: 0
            } : {
        ...
        values: function(e, t) {
            ...
            if (!w.isArray(e)) return this._hasMultipleValues() ? this._values(e) : this.value();
            for (i = this.options.values, a = e, s = 0; i.length > s; s += 1) i[s] = this._trimAlignValue(a[s]), this._change(null, s);
            this._refreshValue()
        },
        _setOption: function(e, t) {
            var i, a = 0;
            switch ("range" === e && !0 === this.options.range && ("min" === t ? (this.options.value = this._values(0), this.options.values = null) : "max" === t && (this.options.value = this._values(this.options.values.length - 1), this.options.values = null)), w.isArray(this.options.values) && (a = this.options.values.length), this._super(e, t), e) {
                case "orientation":
        ...
        _refreshValue: function() {
            ...
            this._hasMultipleValues() ? this.handles.each(function(e) {
                i = (o.values(e) - o._valueMin()) / (o._valueMax() - o._valueMin()) * 100, h["horizontal" === o.orientation ? "left" : "bottom"] = i + "%", w(this).stop(1, 1)[l ? "animate" : "css"](h, r.animate), !0 === o.options.range && ("horizontal" === o.orientation ? (0 === e && o.range.stop(1, 1)[l ? "animate" : "css"]({
                    left: i + "%"
                }, r.animate), 1 === e && o.range[l ? "animate" : "css"]({
                    width: i - t + "%"
                }, {
                    queue: !1,
                    duration: r.animate
            ...
            }) : (e = this.value(), a = this._valueMin(), s = this._valueMax(), i = s !== a ? (e - a) / (s - a) * 100 : 0, h["horizontal" === this.orientation ? "left" : "bottom"] = i + "%", this.handle.stop(1, 1)[l ? "animate" : "css"](h, r.animate), "min" === n && "horizontal" === this.orientation && this.range.stop(1, 1)[l ? "animate" : "css"]({
                width: i + "%"
            }, r.animate), "max" === n && "horizontal" === this.orientation && this.range.stop(1, 1)[l ? "animate" : "css"]({
                width: 100 - i + "%"
            }, r.animate), "min" === n && "vertical" === this.orientation && this.range.stop(1, 1)[l ? "animate" : "css"]({
                height: i + "%"
            }, r.animate), "max" === n && "vertical" === this.orientation && this.range.stop(1, 1)[l ? "animate" : "css"]({
                height: 100 - i + "%"
            }, r.animate))
        },
        _handleEvents: {
            keydown: function(e) {
                var t, i, a, s = w(e.target).data("ui-slider-handle-index");
                switch (e.keyCode) {
                    ...
                    case w.ui.keyCode.LEFT:
                        if (e.preventDefault(), !this._keySliding && (this._keySliding = !0, this._addClass(w(e.target), null, "ui-state-active"), !1 === this._start(e, s))) return
                }
            ...
            keyup: function(e) {
                var t = w(e.target).data("ui-slider-handle-index");
                this._keySliding && (this._keySliding = !1, this._stop(e, t), this._change(e, t), this._removeClass(w(e.target), null, "ui-state-active"))
            }
        }
    })
});
! function(t) {
    ...
    var a = function() {
        function t() {
            var u = this,
                d = function(t) {
                    return v.isNumeric(t) && (t = Math.floor(t)), v('option[value="' + t + '"]', u.$elem)
                },
                l = function(t) {
                    var e = u.$elem.data("barrating");
                    return void 0 !== t ? e[t] : e
                },
                g = function(t, e) {
                    null !== e && "object" == typeof e ? u.$elem.data("barrating", e) : u.$elem.data("barrating")[t] = e
                },
                e = function() {
                    var t, e, n = (e = u.options.initialRating) ? d(e) : v("option:selected", u.$elem),
                        a = !(t = u.$elem.find('option[value="' + u.options.emptyValue + '"]')).length && u.options.allowEmpty ? (t = v("<option />", {
                            value: u.options.emptyValue
                        })).prependTo(u.$elem) : t,
                        i = n.val(),
                        r = n.data("html") ? n.data("html") : n.text(),
                        o = null !== u.options.allowEmpty ? u.options.allowEmpty : !!a.length,
                        l = a.length ? a.val() : null,
                        s = a.length ? a.text() : null;
                    g(null, {
                ...
                p = function(t) {
                    d(t).prop("selected", !0), l("userOptions").triggerChange && u.$elem.change()
                },
                f = function(t) {
                    (t = t || o()) == l("emptyRatingText") && (t = ""), u.options.showSelectedRating && u.$elem.parent().find(".br-current-rating").text(t)
                },
                h = function() {
                    u.$widget.find("a").removeClass(function(t, e) {
                        return (e.match(/(^|\s)br-\S+/g) || []).join(" ")
                    })
                },
                m = function() {
                    var t, e, n, a = u.$widget.find('a[data-rating-value="' + s() + '"]'),
                        i = l("userOptions").initialRating,
                        r = v.isNumeric(s()) ? s() : 0,
                        o = (n = i, Math.round(Math.floor(10 * n) / 10 % 1 * 100));
                    if (h(), a.addClass("br-selected br-current")[c()]().addClass("br-selected"), !l("ratingMade") && v.isNumeric(i)) {
                        if (i <= r || !o) return;
                        t = u.$widget.find("a"), (e = a.length ? a[l("userOptions").reverse ? "prev" : "next"]() : t[l("userOptions").reverse ? "last" : "first"]()).addClass("br-fractional"), e.addClass("br-fractional-" + o)
                    }
                },
                n = function(t) {
                    t.on("click.barrating", function(t) {
                        var e, n, a, i = v(this),
                            r = l("userOptions");
                        return t.preventDefault(), e = i.attr("data-rating-value"), n = i.attr("data-rating-text"), a = i, !(!l("allowEmpty") || !l("userOptions").deselectable) && s() == a.attr("data-rating-value") && (e = l("emptyRatingValue"), n = l("emptyRatingText")), g("ratingValue", e), g("ratingText", n), g("ratingMade", !0), p(e), f(n), m(), r.onSelect.call(u, s(), o(), t), !1
                    })
                },
                a = function(t) {
                    n(t), u.options.hoverState && (t.on("mouseenter.barrating", function() {
                        var t = v(this);
                        h(), t.addClass("br-active")[c()]().addClass("br-active"), f(t.attr("data-rating-text"))
                ...
                r = function(t) {
                    var e = u.$widget.find("a");
                    l("userOptions").fastClicks && e.on("touchstart.barrating", function(t) {
                        t.preventDefault(), t.stopPropagation(), v(this).click()
                    }), t ? (i(e), e.on("click.barrating", function(t) {
                        t.preventDefault()
                    })) : a(e)
                };
            this.show = function() {
                var i, t;
                l() || (t = ["br-wrapper"], "" !== u.options.theme && t.push("br-theme-" + u.options.theme), u.$elem.wrap(v("<div />", {
                    class: t.join(" ")
                })), e(), u.$widget = (i = v("<div />", {
                    class: "br-widget"
                }), u.$elem.find("option").each(function() {
                    var t, e, n, a;
                    (t = v(this).val()) !== l("emptyRatingValue") && (e = v(this).text(), (n = v(this).data("html")) && (e = n), a = v("<a />", {
                        href: "#",
                        "data-rating-value": t,
                        "data-rating-text": e,
                        html: u.options.showValues ? e : ""
                    }), i.append(a))
                }), u.options.showSelectedRating && i.append(v("<div />", {
                    text: "",
                    class: "br-current-rating"
                })), u.options.reverse && i.addClass("br-reverse"), u.options.readonly && i.addClass("br-readonly"), i), u.$widget.insertAfter(u.$elem), m(), f(), r(u.options.readonly), u.$elem.hide())
            }, this.readonly = function(t) {
                "boolean" == typeof t && l("readOnly") != t && (r(t), g("readOnly", t), u.$widget.toggleClass("br-readonly"))
            }, this.set = function(t) {
                var e = l("userOptions");
                0 !== u.$elem.find('option[value="' + t + '"]').length && (g("ratingValue", t), g("ratingText", u.$elem.find('option[value="' + t + '"]').text()), g("ratingMade", !0), p(s()), f(o()), m(), e.silent || e.onSelect.call(this, s(), o()))
            }, this.clear = function() {
                var t = l("userOptions");
                g("ratingValue", l("originalRatingValue")), g("ratingText", l("originalRatingText")), g("ratingMade", !1), v("option", u.$elem).prop("selected", function() {
                    return this.defaultSelected
                }), l("userOptions").triggerChange && u.$elem.change(), f(o()), m(), t.onClear.call(this, s(), o())
            }, this.destroy = function() {
                var t = s(),
                    e = o(),
                    n = l("userOptions");
                i(u.$widget.find("a")), u.$widget.remove(), u.$elem.removeData("barrating"), u.$elem.unwrap(), u.$elem.show(), n.onDestroy.call(this, t, e)
            }
        }
        return t.prototype.init = function(t, e) {
            return this.$elem = v(e), this.options = v.extend({}, v.fn.barrating.defaults, t), this.options
        }, t
    }();
    v.fn.barrating = function(e, n) {
        return this.each(function() {
            var t = new a;
            if (v(this).is("select") || v.error("Sorry, this plugin only works with select fields."), t.hasOwnProperty(e)) {
                if (t.init(n, this), "show" === e) return t.show(n);
                if (t.$elem.data("barrating")) return t.$widget = v(this).next(".br-widget"), t[e](n)
            } else {
                if ("object" == typeof e || !e) return n = e, t.init(n, this), t.show();
                v.error("Method " + e + " does not exist on jQuery.barrating")
            }
        })
...
! function(e) {
    ...
    function t(e) {
        var t = e || window.event,
            ...
            r = 0,
            s = 0;
        if ((e = h.event.fix(t)).type = "mousewheel", "detail" in t && (i = -1 * t.detail), "wheelDelta" in t && (i = t.wheelDelta), "wheelDeltaY" in t && (i = t.wheelDeltaY), "wheelDeltaX" in t && (a = -1 * t.wheelDeltaX), "axis" in t && t.axis === t.HORIZONTAL_AXIS && (a = -1 * i, i = 0), n = 0 === i ? a : i, "deltaY" in t && (n = i = -1 * t.deltaY), "deltaX" in t && (a = t.deltaX, 0 === i && (n = -1 * a)), 0 !== i || 0 !== a) {
            if (1 === t.deltaMode) {
            ...
            if (l = Math.max(Math.abs(i), Math.abs(a)), (!g || l < g) && (m(t, g = l) && (g /= 40)), m(t, l) && (n /= 40, a /= 40, i /= 40), n = Math[1 <= n ? "floor" : "ceil"](n / g), a = Math[1 <= a ? "floor" : "ceil"](a / g), i = Math[1 <= i ? "floor" : "ceil"](i / g), x.settings.normalizeOffset && this.getBoundingClientRect) {
                var u = this.getBoundingClientRect();
                r = e.clientX - u.left, s = e.clientY - u.top
            }
            return e.deltaX = a, e.deltaY = i, e.deltaFactor = g, e.offsetX = r, e.offsetY = s, e.deltaMode = 0, o.unshift(e, n, a, i), p && clearTimeout(p), p = setTimeout(f, 200), (h.event.dispatch || h.event.handle).apply(this, o)
        }
    }
...
function(e) {
    ...
    var H, f, P, n, a, r, i, g, X, S, m, c, s, d, u, h, p, v, x, w, _, b, M, C, y, B, T, k, Y, l, D, O, I, E, j, L, R, A, W, U, F, q, N, V, Q, Z, G, J, K, $, ee, te, oe, ne, ae, ie, le, e, t, o;
    e = "function" == typeof define && define.amd, t = "undefined" != typeof module && module.exports, o = "https:" == document.location.protocol ? "https:" : "http:", e || (t ? require("jquery-mousewheel")(z) : z.event.special.mousewheel || z("head").append(decodeURI("%3Cscript src=" + o + "//cdnjs.cloudflare.com/ajax/libs/jquery-mousewheel/3.1.13/jquery.mousewheel.min.js%3E%3C/script%3E"))), f = "mCustomScrollbar", P = "mCS", n = ".mCustomScrollbar", a = {
            ...
            return l.setWidth = l.set_width ? l.set_width : l.setWidth, l.setHeight = l.set_height ? l.set_height : l.setHeight, l.axis = l.horizontalScroll ? "x" : u(l.axis), l.scrollInertia = 0 < l.scrollInertia && l.scrollInertia < 17 ? 17 : l.scrollInertia, "object" != typeof l.mouseWheel && 1 == l.mouseWheel && (l.mouseWheel = {
                ...
                if (!e.data(P)) {
                    ...
                    var t = e.data(P),
                        ...
                        i = e.data("mcs-theme");
                    n && (o.axis = n), a && (o.scrollbarPosition = a), i && (o.theme = i, s(o)), p.call(this), t && o.callbacks.onCreate && "function" == typeof o.callbacks.onCreate && o.callbacks.onCreate.call(this), z("#mCSB_" + t.idx + "_container img:not(." + S[2] + ")").addClass(S[2]), m.update.call(null, e)
                }
            })
        },
        update: function(e, r) {
            ...
            if (void 0 !== r && null != r) {
                ...
                return z(e).each(function() {
                    ...
                    if (e.data(P)) {
                        ...
                        i[0] = Q.call(this, i[0], "y"), i[1] = Q.call(this, i[1], "x"), a.moveDragger && (i[0] *= t.scrollRatio.y, i[1] *= t.scrollRatio.x), a.dur = le() ? 0 : l, setTimeout(function() {
                            null !== i[0] && void 0 !== i[0] && "x" !== o.axis && t.overflowed[0] && (a.dir = "y", a.overwrite = "all", J(e, i[0].toString(), a)), null !== i[1] && void 0 !== i[1] && "y" !== o.axis && t.overflowed[1] && (a.dir = "x", a.overwrite = "none", J(e, i[1].toString(), a))
                        }, a.timeout)
                    }
                })
            }
        ...
        destroy: function() {
            ...
            return z(l).each(function() {
                ...
                if (e.data(P)) {
                    ...
                    o.live && d(o.liveSelector || z(l).selector), Z.call(this, "remove"), T.call(this), y.call(this), e.removeData(P), te(this, "mcs"), i.remove(), a.find("img." + S[2]).removeClass(S[2]), n.replaceWith(a.contents()), e.removeClass(f + " _" + P + "_" + t.idx + " " + S[6] + " " + S[7] + " " + S[5] + " " + S[3]).addClass(S[4])
                }
            })
        }
    }, c = function() {
        ...
        if (o.advanced.autoExpandHorizontalScroll && "y" !== o.axis) {
            ...
            3 === o.advanced.autoExpandHorizontalScroll || 2 !== o.advanced.autoExpandHorizontalScroll && a > n.parent().width() ? n.css({
                width: a,
                "min-width": "100%",
                "overflow-x": "inherit"
            }) : n.css({
        ...
        function a(e, t, o, n) {
            if (f[0].idleTimer = u.scrollInertia < 233 ? 250 : 0, l.attr("id") === h[1]) var a = "x",
        ...
        t.bind("contextmenu." + e, function(e) {
            ...
            if (e.stopImmediatePropagation(), e.preventDefault(), oe(e)) {
                X = !0, g && (document.onselectstart = function() {
                    return !1
                }), L.call(f, !1), G(c);
                var t = (l = z(this)).offset(),
                    ...
                    a = l.height() + t.top,
                    i = l.width() + t.left;
                o < a && 0 < o && n < i && 0 < n && (r = o, s = n), M(l, "active", u.autoExpandScrollbar)
            }
        ...
        function o(e) {
            if (ne(e) && !X && !Y(e)[2] && (M.documentTouchScroll || e.preventDefault(), e.stopImmediatePropagation(), (!y || C) && h)) {
                ...
                var t = k.offset(),
                    ...
                    n = Y(e)[1] - t.left,
                    a = "mcsLinearOut";
                if (I.push(o), E.push(n), A[2] = Math.abs(Y(e)[0] - A[0]), A[3] = Math.abs(Y(e)[1] - A[1]), T.overflowed[0]) var i = O[0].parent().height() - O[0].height(),
                    l = 0 < c - o && o - c > -i * T.scrollRatio.y && (2 * A[3] < A[2] || "yx" === M.axis);
                if (T.overflowed[1]) var r = O[1].parent().width() - O[1].width(),
                    s = 0 < f - n && n - f > -r * T.scrollRatio.x && (2 * A[2] < A[3] || "yx" === M.axis);
                l || s ? (W || e.preventDefault(), C = 1) : (y = 1, B.addClass("mCS_touch_action")), W && e.preventDefault(), S = "yx" === M.axis ? [c - o, f - n] : "x" === M.axis ? [null, f - n] : [c - o, null], D[0].idleTimer = 250, T.overflowed[0] && u(S[0], L, a, "y", "all", !0), T.overflowed[1] && u(S[1], L, a, "x", R, !0)
            }
        }
        ...
        c.bind("mousedown." + e, function() {
            ...
            if (!H && i && (window.getSelection ? window.getSelection().toString() : document.selection && "Control" != document.selection.type && document.selection.createRange().text)) {
                ...
                0 < o && o < d.height() && 0 < n && n < d.width() ? s.step && a("off", null, "stepped") : ("x" !== r.axis && l.overflowed[0] && (o < 0 ? a("on", 38) : o > d.height() && a("on", 40)), "y" !== r.axis && l.overflowed[1] && (n < 0 ? a("on", 37) : n > d.width() && a("on", 39)))
            }
        ...
        function o(e, t) {
            if (G(u), !R(u, e.target)) {
                var o = "auto" !== f.mouseWheel.deltaFactor ? parseInt(f.mouseWheel.deltaFactor) : g && e.deltaFactor < 100 ? 100 : e.deltaFactor || 100,
                    n = f.scrollInertia;
                if ("x" === f.axis || "x" === f.mouseWheel.axis) var a = "x",
                    ...
                    d = e.deltaY || t;
                "y" === a && !h.overflowed[0] || "x" === a && !h.overflowed[1] || ((f.mouseWheel.invert || e.webkitDirectionInvertedFromDevice) && (d = -d), f.mouseWheel.normalizeDelta && (d = d < 0 ? -1 : 1), (0 < d && 0 !== s || d < 0 && s !== c || f.mouseWheel.preventDefault) && (e.stopImmediatePropagation(), e.preventDefault()), e.deltaFactor < 5 && !f.mouseWheel.normalizeDelta && (l = e.deltaFactor, n = 17), J(u, (r - d * l).toString(), {
                    dir: a,
                    dur: n
                }))
            }
                ...
                case "keyup":
                    ...
                    if ("x" !== c.axis && (38 === o || 40 === o) || "y" !== c.axis && (37 === o || 39 === o)) {
                        ...
                        if ((s.overflowed[0] || s.overflowed[1]) && (e.preventDefault(), e.stopImmediatePropagation()), "keyup" === e.type) {
                            G(r);
                            var a = 34 === o ? -1 : 1;
                            if ("x" === c.axis || "yx" === c.axis && s.overflowed[1] && !s.overflowed[0]) var i = "x",
                                l = Math.abs(u[0].offsetLeft) - a * (.9 * h.width());
                            else var i = "y",
                                l = Math.abs(u[0].offsetTop) - a * (.9 * h.height());
                            J(r, l.toString(), {
                                dir: i,
                                scrollEasing: "mcsEaseInOut"
                            })
        ...
        if (null != e && void 0 !== e) {
            var o = z(this),
                ...
                r = typeof e;
            t || (t = "x" === a.axis ? "x" : "y");
            var s = "x" === t ? i.outerWidth(!1) - l.width() : i.outerHeight(!1) - l.height(),
        ...
        function o() {
            ...
            return l.advanced.updateOnSelectorChange && 0 < t.length && t.each(function() {
        ...
        return e ? (clearTimeout(r[0].autoUpdate), void te(r[0], "autoUpdate")) : void
        function e() {
            return clearTimeout(r[0].autoUpdate), 0 === n.parents("html").length ? void(n = null) : void(r[0].autoUpdate = setTimeout(function() {
                return l.advanced.updateOnSelectorChange && (a.poll.change.n = o(), a.poll.change.n !== a.poll.change.o) ? (a.poll.change.o = a.poll.change.n, void i(3)) : l.advanced.updateOnContentResize && (a.poll.size.n = n[0].scrollHeight + n[0].scrollWidth + r[0].offsetHeight + n[0].offsetHeight + n[0].offsetWidth, a.poll.size.n !== a.poll.size.o) ? (a.poll.size.o = a.poll.size.n, void i(1)) : !l.advanced.updateOnImageLoad || "auto" === l.advanced.updateOnImageLoad && "y" === l.axis || (a.poll.img.n = r.find("img").length, a.poll.img.n === a.poll.img.o) ? void((l.advanced.updateOnSelectorChange || l.advanced.updateOnContentResize || l.advanced.updateOnImageLoad) && e()) : (a.poll.img.o = a.poll.img.n, void r.find("img").each(function() {
                    t(this)
                }))
        ...
        var n, l, r, s = a.data(P),
            ...
            h = z("#mCSB_" + s.idx),
            f = z("#mCSB_" + s.idx + "_container"),
            m = f.parent(),
            p = c.callbacks.onTotalScrollOffset ? V.call(a, c.callbacks.onTotalScrollOffset) : [0, 0],
            g = c.callbacks.onTotalScrollBackOffset ? V.call(a, c.callbacks.onTotalScrollBackOffset) : [0, 0];
        if (s.trigger = i.trigger, 0 === m.scrollTop() && 0 === m.scrollLeft() || (z(".mCSB_" + s.idx + "_scrollbar").css("visibility", "visible"), m.scrollTop(0).scrollLeft(0)), "_resetY" !== e || s.contentReset.y || (t("onOverflowYNone") && c.callbacks.onOverflowYNone.call(a[0]), s.contentReset.y = 1), "_resetX" !== e || s.contentReset.x || (t("onOverflowXNone") && c.callbacks.onOverflowXNone.call(a[0]), s.contentReset.x = 1), "_resetY" !== e && "_resetX" !== e) {
            if (!s.contentReset.y && a[0].mcs || !s.overflowed[0] || (t("onOverflowY") && c.callbacks.onOverflowY.call(a[0]), s.contentReset.x = null), !s.contentReset.x && a[0].mcs || !s.overflowed[1] || (t("onOverflowX") && c.callbacks.onOverflowX.call(a[0]), s.contentReset.x = null), c.snapAmount) {
                var v = c.snapAmount instanceof Array ? "x" === i.dir ? c.snapAmount[1] : c.snapAmount[0] : c.snapAmount;
                n = e, l = v, r = c.snapOffset, e = Math.round(n / l) * l - r
            }
            switch (i.dir) {
                case "x":
                    var x = z("#mCSB_" + s.idx + "_dragger_horizontal"),
                        w = "left",
                        _ = f[0].offsetLeft,
                        S = [h.width() - f.outerWidth(!1), x.parent().width() - x.width()],
                        b = [e, 0 === e ? 0 : e / s.scrollRatio.x],
                        C = p[1],
                        y = g[1],
                        B = 0 < C ? C / s.scrollRatio.x : 0,
                        T = 0 < y ? y / s.scrollRatio.x : 0;
                    break;
                case "y":
                    var x = z("#mCSB_" + s.idx + "_dragger_vertical"),
                        w = "top",
                        _ = f[0].offsetTop,
                        S = [h.height() - f.outerHeight(!1), x.parent().height() - x.height()],
                        b = [e, 0 === e ? 0 : e / s.scrollRatio.y],
                        C = p[0],
                        y = g[0],
                        B = 0 < C ? C / s.scrollRatio.y : 0,
                        T = 0 < y ? y / s.scrollRatio.y : 0
            }
            b[1] < 0 || 0 === b[0] && 0 === b[1] ? b = [0, 0] : b[1] >= S[1] ? b = [S[0], S[1]] : b[0] = -b[0], a[0].mcs || (o(), t("onInit") && c.callbacks.onInit.call(a[0])), clearTimeout(f[0].onCompleteTimeout), K(x[0], w, Math.round(b[1]), u[1], i.scrollEasing), !s.tweenRunning && (0 === _ && 0 <= b[0] || _ === S[0] && b[0] <= S[0]) || K(f[0], w, Math.round(b[0]), u[0], i.scrollEasing, i.overwrite, {
                onStart: function() {
                    i.callbacks && i.onStart && !s.tweenRunning && (t("onScrollStart") && (o(), c.callbacks.onScrollStart.call(a[0])), s.tweenRunning = !0, M(x), s.cbOffsets = [c.callbacks.alwaysTriggerOffsets || _ >= S[0] + C, c.callbacks.alwaysTriggerOffsets || _ <= -y])
                },
                onUpdate: function() {
                    i.callbacks && i.onUpdate && t("whileScrolling") && (o(), c.callbacks.whileScrolling.call(a[0]))
                },
                onComplete: function() {
                    if (i.callbacks && i.onComplete) {
                        ...
                        f[0].onCompleteTimeout = setTimeout(function() {
                            t("onScroll") && (o(), c.callbacks.onScroll.call(a[0])), t("onTotalScroll") && b[1] >= S[1] - B && s.cbOffsets[0] && (o(), c.callbacks.onTotalScroll.call(a[0])), t("onTotalScrollBack") && b[1] <= T && s.cbOffsets[1] && (o(), c.callbacks.onTotalScrollBack.call(a[0])), s.tweenRunning = !1, f[0].idleTimer = 0, M(x, "hide")
                        }, e)
                    }
                }
            })
        ...
        function s() {
            v[t] = 0 < n ? (x.currVal = function(e, t, o, n, a) {
                switch (a) {
                    case "linear":
                    case "mcsLinear":
                        return o * e / n + t;
            ...
            }(x.time, g, w, n, a), Math.round(x.currVal) + "px") : o + "px", h.call()
        }
        e._mTween || (e._mTween = {
            top: {},
            left: {}
        ...
        z(n)[f](), z.extend(z.expr[":"], {
            mcsInView: z.expr[":"].mcsInView || function(e) {
                ...
                if (a.length) return t = a.parent(), 0 <= (o = [a[0].offsetTop, a[0].offsetLeft])[0] + ie(n)[0] && o[0] + ie(n)[0] < t.height() - n.outerHeight(!1) && 0 <= o[1] + ie(n)[1] && o[1] + ie(n)[1] < t.width() - n.outerWidth(!1)
            },
            mcsInSight: z.expr[":"].mcsInSight || function(e, t, o) {
                ...
                if (s.length) return n = [r.outerHeight(!1), r.outerWidth(!1)], i = [s[0].offsetTop + ie(r)[0], s[0].offsetLeft + ie(r)[1]], a = [s.parent()[0].offsetHeight, s.parent()[0].offsetWidth], i[0] - a[0] * (l = [n[0] < a[0] ? c[0] : c[1], n[1] < a[1] ? c[0] : c[1]])[0][0] < 0 && 0 <= i[0] + n[0] - a[0] * l[0][1] && i[1] - a[1] * l[1][0] < 0 && 0 <= i[1] + n[1] - a[1] * l[1][1]
            },
    ...
    function _(t) {
        if (function() {
                if (!x) {
                    ...
                    e.appendChild(t);
                    var i = v(t);
                    z = 200 == Math.round(y(i.width)), _.isBoxSizeOuter = z, e.removeChild(t)
                }
...
function(o, r) {
    ...
    function s(t, e) {
        ...
        if (i) {
            ...
            var n = ++d;
            this.element.outlayerGUID = n, (l[n] = this)._create(), this._getOption("initLayout") && this.layout()
    ...
    var c = s.prototype;
    r.extend(c, e.prototype), c.option = function(t) {
        ...
        this.resize()
    }, r.debounceMethod(s, "onresize", 100), c.resize = function() {
...
function(c, t, e, i) {
    ...
    s.Defaults = {
        ...
        var i, s, n = t.width && t.height ? "width:" + t.width + "px;height:" + t.height + "px;" : "",
            ...
            l = function(t) {
                '<div class="owl-video-play-icon"></div>', i = h.lazyLoad ? c("<div/>", {
...
! function(n) {
    ...
    var e = function() {
            ...
            var t, r, c, u;
            return e && e.requirejs || (e ? c = e : e = {}, function(h) {
                function f(e, t) {
                    return n.call(e, t)
                }
                ...
                function a(e, t) {
                    var n, i, r, o, s, a, l, c, u, d, p, h = t && t.split("/"),
                        ...
                        g = f && f["*"] || {};
                    if (e) {
                        for (s = (e = e.split("/")).length - 1, x.nodeIdCompat && D.test(e[s]) && (e[s] = e[s].replace(D, "")), "." === e[0].charAt(0) && h && (e = h.slice(0, h.length - 1).concat(e)), u = 0; u < e.length; u++)
                ...
                function v(e) {
                    if (f(b, e)) {
                        var t = b[e];
                        delete b[e], A[e] = !0, o.apply(h, t)
                    }
                    if (!f($, e) && !f(A, e)) throw new Error("No " + e);
                    return $[e]
                }
                ...
                _ = function(e, t) {
                    var n, i, r = l(e),
                        o = r[0],
                        s = t[1];
                    return e = r[1], o && (n = v(o = a(o, s))), o ? e = n && n.normalize ? n.normalize(e, (i = s, function(e) {
                        return a(e, i)
                    })) : a(e, s) : (o = (r = l(e = a(e, s)))[0], e = r[1], o && (n = v(o))), {
                        f: o ? o + "!" + e : e,
                        n: e,
                        pr: o,
                        p: n
                    ...
                    if (c = y(i = i || e), "undefined" === p || "function" === p) {
                        for (t = !t.length && n.length ? ["require", "exports", "module"] : t, l = 0; l < t.length; l += 1)
                            if ("require" === (o = (a = _(t[l], c)).f)) d[l] = w.require(e);
                            else if ("exports" === o) d[l] = w.exports(e), u = !0;
                        else if ("module" === o) r = d[l] = w.module(e);
                        else if (f($, o) || f(b, o) || f(A, o)) d[l] = v(o);
                        else {
                            if (!a.p) throw new Error(e + " missing " + o);
                            a.p.load(a.n, g(i, !0), m(o), {}), d[l] = $[o]
                        }
                        s = n ? n.apply($[e], d) : void 0, e && (r && r.exports !== h && r.exports !== $[e] ? $[e] = r.exports : s === h && u || ($[e] = s))
                    } else e && ($[e] = n)
                }, r = c = s = function(e, t, n, i, r) {
                    if ("string" == typeof e) return w[e] ? w[e](t) : v(_(e, y(t)).f);
                    if (!e.splice) {
                        if ((x = e).deps && s(x.deps, x.callback), !t) return;
                    ...
                    return s(e)
                }, r._defined = $, (u = function(e, t, n) {
                    if ("string" != typeof e) throw new Error("See almond README: incorrect module build, no module name");
                    t.splice || (n = t, t = []), f($, e) || f(b, e) || (b[e] = [e, t, n])
                }).amd = {
                    jQuery: !0
                }
            }(), e.requirejs = r, e.require = c, e.define = u), e.define("almond", function() {}), e.define("jquery", [], function() {
                var e = n || $;
                ...
                return n.prototype.apply = function(t) {
                    if (null == (t = f.extend(!0, {}, this.defaults, t)).dataAdapter) {
                        if (null != t.ajax ? t.dataAdapter = C : null != t.data ? t.dataAdapter = S : t.dataAdapter = D, 0 < t.minimumInputLength && (t.dataAdapter = x.Decorate(t.dataAdapter, q)), 0 < t.maximumInputLength && (t.dataAdapter = x.Decorate(t.dataAdapter, T)), 0 < t.maximumSelectionLength && (t.dataAdapter = x.Decorate(t.dataAdapter, j)), t.tags && (t.dataAdapter = x.Decorate(t.dataAdapter, E)), null == t.tokenSeparators && null == t.tokenizer || (t.dataAdapter = x.Decorate(t.dataAdapter, O)), null != t.query) {
                    ...
                    if (null == t.resultsAdapter && (t.resultsAdapter = m, null != t.ajax && (t.resultsAdapter = x.Decorate(t.resultsAdapter, I)), null != t.placeholder && (t.resultsAdapter = x.Decorate(t.resultsAdapter, P)), t.selectOnClose && (t.resultsAdapter = x.Decorate(t.resultsAdapter, U))), null == t.dropdownAdapter) {
                        if (t.multiple) t.dropdownAdapter = L;
                        else {
                            var i = x.Decorate(L, k);
                            t.dropdownAdapter = i
                        }
                        if (0 !== t.minimumResultsForSearch && (t.dropdownAdapter = x.Decorate(t.dropdownAdapter, R)), t.closeOnSelect && (t.dropdownAdapter = x.Decorate(t.dropdownAdapter, z)), null != t.dropdownCssClass || null != t.dropdownCss || null != t.adaptDropdownCssClass) {
                    ...
                    if (null == t.selectionAdapter) {
                        if (t.multiple ? t.selectionAdapter = y : t.selectionAdapter = v, null != t.placeholder && (t.selectionAdapter = x.Decorate(t.selectionAdapter, _)), t.allowClear && (t.selectionAdapter = x.Decorate(t.selectionAdapter, w)), t.multiple && (t.selectionAdapter = x.Decorate(t.selectionAdapter, $)), null != t.containerCssClass || null != t.containerCss || null != t.adaptContainerCssClass) {
                ...
                function t(e) {
                    var t = e || window.event,
                        ...
                        a = 0,
                        l = 0;
                    if ((e = p.event.fix(t)).type = "mousewheel", "detail" in t && (o = -1 * t.detail), "wheelDelta" in t && (o = t.wheelDelta), "wheelDeltaY" in t && (o = t.wheelDeltaY), "wheelDeltaX" in t && (r = -1 * t.wheelDeltaX), "axis" in t && t.axis === t.HORIZONTAL_AXIS && (r = -1 * o, o = 0), i = 0 === o ? r : o, "deltaY" in t && (i = o = -1 * t.deltaY), "deltaX" in t && (r = t.deltaX, 0 === o && (i = -1 * r)), 0 !== o || 0 !== r) {
                        if (1 === t.deltaMode) {
                        ...
                        if (s = Math.max(Math.abs(o), Math.abs(r)), (!m || s < m) && (f(t, m = s) && (m /= 40)), f(t, s) && (i /= 40, r /= 40, o /= 40), i = Math[1 <= i ? "floor" : "ceil"](i / m), r = Math[1 <= r ? "floor" : "ceil"](r / m), o = Math[1 <= o ? "floor" : "ceil"](o / m), y.settings.normalizeOffset && this.getBoundingClientRect) {
                            var d = this.getBoundingClientRect();
                            a = e.clientX - d.left, l = e.clientY - d.top
                        }
                        return e.deltaX = r, e.deltaY = o, e.deltaFactor = m, e.offsetX = a, e.offsetY = l, e.deltaMode = 0, n.unshift(e, i, r, o), g && clearTimeout(g), g = setTimeout(h, 200), (p.event.dispatch || p.event.handle).apply(this, n)
                    }
                }
            ...
            }, "function" == typeof e.define && e.define.amd ? e.define("jquery-mousewheel", ["jquery"], t) : "object" == typeof exports ? module.exports = t : t(n), e.define("jquery.select2", ["jquery", "jquery-mousewheel", "./select2/core", "./select2/defaults", "./select2/utils"], function(r, e, o, t, s) {
...
! function(i) {
    ...
    s = 0, (r = function(i, e) {
        ...
        var o = this;
        return i = "boolean" == typeof i ? !0 === (e = i) ? 0 : o.slideCount - 1 : !0 === e ? --i : i, !(o.slideCount < 1 || i < 0 || i > o.slideCount - 1) && (o.unload(), !0 === t ? o.$slideTrack.children().remove() : o.$slideTrack.children(this.options.slide).eq(i).remove(), o.$slides = o.$slideTrack.children(this.options.slide), o.$slideTrack.children(this.options.slide).detach(), o.$slideTrack.append(o.$slides), o.$slidesCache = o.$slides, void o.reinit())
