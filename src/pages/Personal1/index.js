                ...
                <div className="atbd_content_module">
                  ...
                  <div className="atbdb_content_module_contents">
                    <form action="#">
                      ...
                      <div className="form-group">
                        <label htmlFor="tagline" className="form-label">Name of Person</label>
                        <input type="text" className="form-control" id="tagline" placeholder="Enter Person Name" required style={{border:'1px solid rgb(255, 0, 0)'}}/>
                      </div>
                      <div className="form-group">
                                ...
                                <div className="form-group">
                                  <div className="select-basic">
                                    <select className="form-control" style={{border:'1px solid rgb(255, 0, 0)'}}>
                                      ...
                                      <option value="Pan no."> Passport No.</option>
                                      <option value="LLP no."> Driving License No.</option>
                                      <option value="Cin no."> Adhaar No.</option>
                      ...
                      <div className="form-group">
                        ...
                        <input type="text" name="manual_lng" id="manual_lng" className="form-control directory_field" placeholder="Enter Email" style={{border:'1px solid rgb(255, 0, 0)'}}/>
                      </div>
                      <div className="form-group">
                      ...
                      <div className="btn_wrap list_submit m-top-25 vert-offset-top-3 vert-offset-bottom-4 offset-10">
                        <Link class="modal-view button" to={'personal2'} data-toggle="popover" style={{ backgroundColor: '#258ccc', textDecoration: 'none', color: 'white' }}>Next</Link>
                      </div>
