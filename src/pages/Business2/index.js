              ...
              <div className="col-lg-8 vert-offset-top-2">
                <div className="atbd_content_module">
                  ...
                  <div className="form-group">
                    ...
                    <textarea id="short_desc" rows={5} className="form-control" placeholder="Enter Full Description" defaultValue={""} style={{border:'1px solid rgb(255, 0, 0)'}}/>
                  </div>
                  <div className="form-group">
                        ...
                        <div className="cor-form">
                          ...
                          <div className="form-group">
                            <div className="atbd_mark_as_closed custom-control custom-checkbox checkbox-outline checkbox-outline-primary">
                              ...
                              {/* <input type="checkbox" className="custom-control-input" name="listing_t" defaultValue={1} id="listing_t" /> */}

                              {/* < label htmlFor="listing_t" className="not_empty custom-control-label"><Link to='#' id="listing_t_c">I Agree with all Terms &amp; Conditions</Link></label> */}
